...
class CI_Email {
	...
	var	$smtp_user		= "purohit.dynamic@gmail.com";	// SMTP Username
	var	$smtp_pass		= "*98432401239500918886*";	// SMTP Password
	...
	var	$bcc_batch_mode	= TRUE;	// TRUE/FALSE  Turns on/off Bcc batch feature
	var	$bcc_batch_size	= TRUE;		// If bcc_batch_mode = TRUE, sets max number of Bccs in each batch
	var $_safe_mode		= TRUE;
	var	$_subject		= "";
	var	$_body			= "";
	var	$_finalbody		= "";
