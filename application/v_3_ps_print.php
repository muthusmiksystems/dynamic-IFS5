        ...
        <div class="row">
          <div class="col-lg-12">
            ...
            ?>
                  ...
                  <tbody>
                    <tr>
                      <td colspan="3" align="center">
                        <h3>Production Work Sheet of Dynamic Label Division</h3>
                      </td>
                    </tr>
                    <tr>
                        ...
                        <table class="table table-bordered table-condensed">
                          <tbody>
                            ...
                            foreach ($ps_items as $item) {
                              ...
                              $repeats = 0;
                              $repeats = round(($tot_qty / (($machine_no_tapes_act / $tot_warp_ends) * $machine_no_tapes)));
                              $time = 0;
              ...
              <a onclick="window.print()" class="btn btn-danger screen-only" type="button" href="<?= base_url() . 'purchase_order/po_list_lbl' ?>">Print</a>
            <?php
            }
            ?>
            <!-- End Talbe List  -->
