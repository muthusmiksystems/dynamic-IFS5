      ...
      <section id="container" class="">
         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>Mir_reports/abstract_report_3">
                  <div class="row">
                     <div class="col-lg-12">
                        <section class="panel">                            
                           <header class="panel-heading">
                           ...
                           <table id="example" class="datatable table table-bordered table-striped table-condensed cf packing-register">
                              <thead>
                                <tr>
                                    ...
                                    <th><strong color='red'><?php echo round($item_detail['tot_prod_qty']/1000,2); ?></strong></th>
                                    <th><strong color='red'><?php echo round($item_detail['tot_prod_amt']/100000,2); ?></strong></th>
                                    <th><strong color='red'><?php echo round(array_sum($item_detail['tot_pkd_qty'])/1000,2); ?></strong></th>
                                    <th><strong color='red'><?php echo round(array_sum($item_detail['tot_pkd_amt'])/100000,2); ?></strong></th>
                                    <th><strong color='red'><?php echo round($item_detail['tot_inv_qty']/1000,2); ?></strong></th>
                                    ...
                                    <th><strong color='red'><?php echo round($item_detail['tot_pkd_qty']['del']/1000,2); ?></strong></th>
                                    <th><strong color='red'><?php echo round($item_detail['tot_pkd_qty']['stock']/1000,2); ?></strong></th>
                                    ...
                                    echo round($qty/1000,2); ?></strong></th>
                                    <th><strong color='red'><?php 
                                 ...
                                 <tr>
                                    <th>#</th>  
                                    <th>Term</th>
                                    <th>Qty Prod. in Tonnes</th>
                                    <th>Val. of Qty Prod. in L</th>
                                    <th>Qty Pkd. in Tonnes</th>
                                    <th>Val. of Qty Pkd. in L</th>
                                    <th>Qty Invoiced in Tonnes</th>
                                    <th>Invoiced before Tax in L</th>
                                    <th>Invoiced after Tax in L</th>
                                     <th>Qty delvd. in Tonnes</th>
                                    <th>Qty Stock in Tonnes</th>
                                    <th>Val. of Qty Stock in L</th>
                                    <th>Qty Non-Invoiced in Tonnes</th>
                                    <th>Val. of Qty Non-Invoiced in L</th>
                                 </tr>
                              </thead>
                              <tfoot>
                                <tr>
                              ...
                              <?php
                                 ...
                                 foreach ($item_detail['details'] as  $term=>$term_value) {
                                    ...
                                    <tr>
                                       <td><?=$sno; ?></td>
                                       <td><?=$term;?></td>
                                       <td><?=round($term_value['prod_qty']/1000,2);?></td>
                                       <td><?=round($term_value['prod_amt']/100000,2);?></td>
                                       <td><?=round(array_sum($term_value['pkd_qty'])/1000,2);?></td>
                                       <td><?=round(array_sum($term_value['pkd_amt'])/100000,2);?></td>
                                       <td><?=round($term_value['inv_qty']/1000,2);?></td>
                                       <td><?=round($term_value['inv_amt_b']/100000,2);?></td>
                                       <td><?=round($term_value['inv_amt_a']/100000,2);?></td>
                                       <td><?=round($term_value['pkd_qty']['del']/1000,2);?></td>
                                       <td><?=round($term_value['pkd_qty']['stock']/1000,2);?></td>
                                       <td><?=round($term_value['pkd_amt']['stock']/100000,2);?></td>
                                       <td><?php
                                          $non_inv=$term_value['pkd_qty']['del']-$term_value['inv_qty'];
                                          echo round($non_inv/1000,2);
                                       ?></td>
                                       <td><?php
