	...
	if($packing_type == 'qtywise')
	{
		...
		<table style="width:100%;margin:0 auto;">
			...
			<tr>
				...
				<td>Box No : </td>
				<td colspan="3" align="left"><strong style="font-size:20px;">M-<?=$box_no; ?></strong></td><!--to reduce box_no and concern fontsize in packingslip te-->
			</tr>
			<tr>
			...
			<tr>
				...
				<td colspan="3">Lot No: <?php echo $dyed_lot_no; ?></td>
			</tr>
			...
			<tr class="border-top">
				...
				<td colspan="3">
					...
					Packed by: <?=$this->m_masters->getmasterIDvalue('bud_users', 'ID', $packing_by, 'user_nicename')?><br/>
			...
			<tr>
				<td colspan="6" align="center" style="border-top:1px solid #000;">
					...
					<strong>"SHIVA TAPES"</strong><span style="font-size:8px;"> a concern of </span><strong>"DYNAMIC DOST"</strong><!--to reduce box_no and concern fontsize in packingslip te-->
				</td>
			</tr>		
		</table>
		<?php
