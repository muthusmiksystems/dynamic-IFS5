            ...
            <section class="wrapper">
                  ...
                  <div class="col-lg-12">
                     <section class="panel">
                        <header class="panel-heading">
                           <h3><i class="icon-dropbox"></i> Out box packing (Kgs)</h3>
                        </header>
               ...
               <div class="row">
                  ...
                  ?>
                     ...
                     <form class="cmxform form-horizontal tasi-form packing-form" role="form" id="commentForm" method="post" action="<?=base_url();?>production/outerbox_pack_kgs_save">
                     <div class="col-lg-12">
                     ...
                     <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                <button tabindex="14" class="btn btn-danger" type="submit">Save</button>
                                                ...
                                                <div class="modal-content">
                                                   ...
                                                   <div class="modal-body">
                                                      <form role="form" method="post" action="<?=base_url(); ?>production/delete_box_2">
                                                         ...
                                                         <input type="hidden" name="function_name" value="outerbox_pack_kgs">
