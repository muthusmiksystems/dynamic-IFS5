               ...
               <div class="col-lg-12">
                  ...
                  <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        ?>
                        <h3 class="visible-print">Packing Register (Yarn &amp; Thread)</h3>
                        <div class="col-sm-6">
                        ...
                        foreach ($cust_pack_register as $item_id => $outerboxes) {
                           ...
                           ?>
                           <div class="col-sm-6">
                              Item Code : <strong><?php echo $item_code; ?></strong><br/>                           
                              Item Name : <strong><?php echo $item_name; ?></strong>                           
                           </div>
                           <table id="example" class="datatable table table-bordered table-striped table-condensed cf packing-register">
                            <thead>
                              ...
                              <tr>
                                 <th></th>                         
                                 <th><?=count($total_boxes_array[$item_id]); ?> Boxes</th>
                                 <th></th>
                                 <th></th>
                                 <th></th>
                                 <th></th>
                                 <th></th>
                                 <th><?=number_format(array_sum($tot_gr_weight_array[$item_id]), 3, '.', ''); ?></th>
