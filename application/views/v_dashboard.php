    ...
    <section id="container" class="">
        ...
        <section id="main-content">
            <section class="wrapper">
                ...
                $requsers = $this->m_purchase->getDatas('bud_users', 'ID', $this->session->userdata('user_id'));
                $user_access_modules = '';
                foreach ($requsers as $user) {
                    $user_access_modules = $user['user_access_modules'];
                }
                $access_modules = explode(",", $user_access_modules);
                if ($is_admin && $this->session->userdata('logged_as') == 'user') {
                ?>
                    <div class="row state-overview">
                        <div class="col-lg-3 col-sm-6">
                            <section class="panel">
                                ...
                                <div class="value">
                                    <a href="<?= base_url(); ?>dashboard/categorieshome/1">Yarn &amp; Thread</a>
                                </div>
                            </section>
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <section class="panel">
                                ...
                                <div class="value">
                                    <a href="<?= base_url(); ?>dashboard/categorieshome/2">Tapes &amp; Zippers</a>
                                </div>
                            </section>
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <section class="panel">
                                ...
                                <div class="value">
                                    <a href="<?= base_url(); ?>dashboard/categorieshome/3">Labels</a>
                                </div>
                            </section>
                        </div>
                        <div class="col-lg-3 col-sm-6">
                            <section class="panel">
                                ...
                                <div class="value">
                                    <a href="<?= base_url(); ?>dashboard/categorieshome/4">Medicle Tapes</a>
                                </div>
                            </section>
                        </div>
                    </div>
                ...
                <?php
                } elseif ($this->session->userdata('logged_as') == 'user') {
                ?>
                    <div class="row state-overview">
                        <?php
                            ...
                            <div class="col-lg-3 col-sm-6">
                                <section class="panel">
                                    ...
                                    <div class="value">
                                        <?php
                                        if ($module == 1) {
                                            echo '<a href="' . base_url() . 'dashboard/categorieshome/1">Yarn & Thread</a>';
                                        }
                                        if ($module == 2) {
                                            echo '<a href="' . base_url() . 'dashboard/categorieshome/2">Tapes & Elastic</a>';
                                        }
                                        if ($module == 3) {
                                            echo '<a href="' . base_url() . 'dashboard/categorieshome/3">Label</a>';
                                        }
                                        if ($module == 4) {
                                            echo '<a href="' . base_url() . 'dashboard/categorieshome/4">Medicle Tapes</a>';
                                        }
                                        ?>
                                    </div>
                                </section>
                        ...
                        <section class="panel">
                            <div class="panel-body">
                                <a href="#" class="task-thumb">
                                    <img src="<?= base_url() ?>themes/default/img/avatar1.jpg" alt="">
                                </a>
                                        ...
                                        <div class="timeline-desk">
                                            <div class="panel">
                                                <div class="panel-body">
                                                    ...
                                                    <div class="album">
                                                        <a href="#">
                                                            <img alt="" src="<?= base_url() ?>themes/default/img/sm-img-1.jpg">
                                                        </a>
                                                        <a href="#">
                                                            <img alt="" src="<?= base_url() ?>themes/default/img/sm-img-2.jpg">
                                                        </a>
                                                        <a href="#">
                                                            <img alt="" src="<?= base_url() ?>themes/default/img/sm-img-3.jpg">
                                                        </a>
                                                        <a href="#">
                                                            <img alt="" src="<?= base_url() ?>themes/default/img/sm-img-1.jpg">
                                                        </a>
                        ...
                        <section class="panel post-wrap pro-box">
                            ...
                            <aside class="post-highlight yellow v-align">
                                <div class="panel-body text-center">
                                    <div class="pro-thumb">
                                        <img src="<?= base_url() ?>themes/default/img/ring.jpg" alt="">
                                    </div>
                                </div>
                            </aside>
                        </section>
                                    ...
                                    <div class="follower">
                                        <div class="panel-body">
                                            ...
                                            <div class="follow-ava">
                                                <img src="<?= base_url() ?>themes/default/img/follower-avatar.jpg" alt="">
                                            </div>
                                        </div>
                                    </div>
