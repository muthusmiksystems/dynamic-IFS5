      ...
      <section id="container" class="">
         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               $item_groups = $this->m_masters->getactivemaster('bud_lbl_itemgroups', 'group_status');
               $item_name = null;
               $item_group_id=null;  
             ?>
               <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>reports/packingRegister_3">
                  <div class="row">
                     <div class="col-lg-12">
                        <section class="panel">                                               <header class="panel-heading">
                           ...
                           <div class="panel-body">
                              ...
                              <div class="form-group col-lg-3">
                                 <label for="item_name">Item Group Name</label>
                                 <select class="form-control select2"  name="item_group_id">
                    ...
                    <div class="panel-body">
                        ...
                        ?>                                    <table id="example" class="table datatable table-bordered table-striped table-condensed cf packing-register">
                         <thead>
                           ...
                           <tr>
                              <th width="5%">#</th>                                               <th width="5%">Box No</th>
                              <th width="15%">Item Group</th>
                              <th width="20%">Item Name/Code</th>
                              <th width="20%">Size Tot. Qty</th>
