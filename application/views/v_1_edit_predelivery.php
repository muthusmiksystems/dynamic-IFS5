      ...
      <section id="container" class="">
         ...
         <section id="main-content">
            <section class="wrapper sh_delivery">
               ...
               ?>
               <form class="cmxform form-horizontal tasi-form" role="form" id="commentForm" method="post" action="<?=base_url('delivery/predelivery_1_edit/'.$p_delivery_id);?>">
                               ...
                               <tbody>
                                  ...
                                  foreach ($d_outerboxes as $row) {
                                      ...
                                      <tr>
                                          ...
                                          <td>
                                              <?=$row['gross_weight']; ?>
                                              <input type="hidden" class="grant_wt" id="mtr_<?=$row['box_id']; ?>" value="<?=$row['gross_weight']; ?>">                                                                            </td>
                                          <td>
                                              <?=$row['net_weight']; ?>
                                              <input type="hidden" class="net_weight" id="wt_<?=$row['box_id']; ?>" value="<?=$row['net_weight']; ?>">
                                          </td>
                  ...
                  <form class="cmxform form-horizontal tasi-form" role="form" id="commentForm" method="post" action="<?=base_url();?>delivery/predelivery_1_update">
