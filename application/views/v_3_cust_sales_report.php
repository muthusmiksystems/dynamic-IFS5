      ...
      <section id="container" class="">
         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>Mir_reports/cust_sales_report_3">
                  <div class="row">
                     <div class="col-lg-12">
                        <section class="panel">                            
                           <header class="panel-heading">
                           ...
                           <div class="panel-body">
                              ...
                              <div class="form-group col-lg-3">
                                 ...
                                 <select class="get_cust_detail form-control select2" id="cust_name" name="cust_name">
                                    <option value="0">Select</option>
                                    <?php
                                    foreach ($cust as $row) {
                                      ?>
                              ...
                              <div class="form-group col-lg-3">
                                 <label for="cust_id">Customer Code</label>
                                 <select class="get_cust_detail form-control select2" id="cust_id" name="cust_id">
                                    <option value="0">Select</option>
                                    <?php
                                    foreach ($cust as $row) {
                                      ?>
                           ...
                           <table id="example" class="datatable table table-bordered table-striped table-condensed cf packing-register">
                              <thead>
                                 <tr>
                                    ...
                                    <th><strong color='red'><?php echo $grand_item_detail['tot_invs']; ?></strong></th>
                                    <th></th>
                                    <th><strong color='red'><?php echo $grand_item_detail['tot_inv_wt']; ?></strong></th>
                                    <th><strong color='red'><?php echo $grand_item_detail['tot_inv_rate']; ?></strong></th>
                                    <th><strong color='red'><?php echo $grand_item_detail['tot_inv_amt']; ?></strong></th>
                                 </tr>
                                 <tr>
                                    <th></th>
                                    <th></th>
                                    <th></th>
                                    <th><strong color='red'>Total:<strong></th>
                                    <th><strong color='red'><?php echo $item_detail['tot_invs']; ?></strong></th>
                                    <th></th>
                                    <th><strong color='red'><?php echo $item_detail['tot_inv_wt']; ?></strong></th>
                                    <th><strong color='red'><?php echo $item_detail['tot_inv_rate']; ?></strong></th>
                                    <th><strong color='red'><?php echo $item_detail['tot_inv_amt']; ?></strong></th>
                                 </tr>
                                 <tr>
                                    <th>#</th>  
                                    <th>Term</th>
                                    <th>Customer Name</th>
                                    <th>Invoices Items</th>
                                    <th># Invoices</th>
                                    <th>Invoices</th>
                                    <th>Tot. Inv. Qty</th>
                                    <th>Tot.Inv. Price(Before Tax)</th>
                                    <th>Tot.Inv. Price(After Tax)</th>
                                 </tr>
                              </thead>
                              <tfoot>
                                <tr>
                              ...
                              <?php
                                 $sno=1;
                                 foreach ($item_detail as $cust=>$cust_value) {
                                    if(($cust=='tot_inv_wt')||($cust=='tot_invs')||($cust=='tot_inv_rate')||($cust=='tot_inv_amt'))
                                    {
                                       continue;
                                    }
                                    foreach ($cust_value as $term=>$term_value) {
                                    ?>
                                    <tr>
                                       <td><?=$sno; ?></td>
                                       <td><?=$term;?></td>
                                       ...
                                       <td>
                                          <?php 
                                          echo '['.sizeof($term_value['inv_items']).']-';
                                          foreach ($term_value['inv_items'] as $item_id =>$item_name) {
                                             ?>
                                             <?=$item_name.'/'.$item_id.',';?>
                                             <?php
                                          }
                                       ...
                                       <td><?=sizeof($term_value['inv_no']);?></td>
                                       <td>
                                          <?php 
                                          foreach ($term_value['inv_no'] as $inv_id =>$inv_no) {
                                             ?>
                                             <?=$inv_no.'/'.$inv_id.',';?>
                                             <?php
                                          }
                                       ...
                                       <td><?=array_sum($term_value['inv_wt']);?></td>
                                       <td><?=array_sum($term_value['rate']);?></td>
                                       <td><?=array_sum($term_value['amount']);?></td>
                                    </tr>
                                    <?php
                                    $sno++;
                                    }
