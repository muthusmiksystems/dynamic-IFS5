...
<html lang="en">
   ...
   <body>
            ...
            <section class="wrapper">
               ...
               <div class="row">
                  ...
                  ?>
                     ...
                     <form class="cmxform form-horizontal tasi-form packing-form" role="form" id="commentForm" method="post" action="<?=base_url();?>production/outerbox_pack_without_ib_save">
                     <div class="col-lg-12">
                           ...
                           <div class="panel-body">
                              <div class="col-lg-5">
                                 ...
                                 <div class="form-group col-lg-8 no-padding">
                                    ...
                                    <select tabindex="2" class="getitemdata form-control select2" id="packing_item" name="packing_item" type="text">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input tabindex="3" class="rolls form-control" id="packing_rolls" name="packing_rolls" value="<?=$packing_rolls; ?>" type="text">
                                 </div>
                                 <div class="form-group col-lg-6 no-padding">
                                    <label for="packing_wt_mtr">Wt / Mtr (Default)</label>
                                    <input class="rolls form-control" id="packing_wt_mtr" name="packing_wt_mtr" type="text" value="<?=$packing_wt_mtr; ?>" readonly="readonly">
                                 </div>
                                 <div class="form-group col-lg-6 no-padding right">
                                    <label for="packing_wt_mtr_new">Wt / Mtr (New)</label>
                                    <input tabindex="4" class="rolls form-control" id="packing_wt_mtr_new" name="packing_wt_mtr_new" value="<?=$packing_wt_mtr_new; ?>" type="text">
                                 </div>
                                 <div class="form-group">
                                    <label for="packing_tot_mtr">Total Meters</label>
                                    <input tabindex="-1" class="form-control" id="packing_tot_mtr" name="packing_tot_mtr" type="text" value="0" readonly="readonly">
                                 </div>
                              </div>
                              <div class="col-lg-4">
                                 <div class="form-group">
                                    <label for="packing_gr_weight">Gross Weight</label>
                                    <input autofocus tabindex="1" class="weight form-control" id="packing_gr_weight" name="packing_gr_weight" type="number" style="font-size:26px;padding: 0px 12px;">
                                 </div>                                                       <div class="form-group col-lg-6 no-padding">
                                    <label for="packing_box_weight">Box Name</label>
                                    <select tabindex="5" class="weight form-control select2" id="packing_box_weight" name="packing_box_weight">
                                 ...
                                 <div class="form-group col-lg-6">
                                    ...
                                    <input tabindex="6" class="weight form-control" id="packing_no_boxes" name="packing_no_boxes" value="<?=$packing_no_boxes; ?>" type="text">
                                 </div>
                                 <div class="form-group col-lg-6 no-padding">
                                    <label for="packing_bag_weight">Poly Bag</label>
                                    <select tabindex="7" class="weight form-control select2" id="packing_bag_weight" name="packing_bag_weight">
                                       <option value="0">Select Box</option>
                                       <?php
                                       foreach ($tareweights as $tareweight) {
                                          ?>
                                 ...
                                 <div class="form-group col-lg-6">
                                    ...
                                    <input tabindex="8" class="weight form-control" id="packing_no_bags" name="packing_no_bags" value="<?=$packing_no_bags; ?>" type="text">
                                 </div>
                                 <div class="form-group">
                                    <label for="packing_othr_wt">Other Merial Weight</label>
                                    <input tabindex="9" class="weight form-control" id="packing_othr_wt" name="packing_othr_wt" type="text" value="<?=$packing_othr_wt; ?>">
                                 </div>
                                 <div class="form-group">
                                    <label for="packing_net_weight">Net Weight</label>
                                    <input tabindex="-1" class="form-control" id="packing_net_weight" name="packing_net_weight" value="0" type="text" readonly="readonly">
                                 </div> 
                                                                                    </div>
                              <div class="col-lg-3">
                                 <div class="form-group">
                                    <label for="packing_cust">Party Name</label>
                                    <select tabindex="11" class="select2 form-control" data-placeholder="Select Operator" name="packing_cust" id="packing_cust">
					...
					<textarea name="remark" class="form-control" style="resize: vertical;" required="required"><?=$remark; ?></textarea>
                     ...
                     <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                <button tabindex="14" class="btn btn-danger" id="sav_but">Save</button>
                                                ...
                                                <div class="modal-content">
                                                   ...
                                                   <div class="modal-body">
                                                      <form role="form" method="post" action="<?=base_url(); ?>production/delete_box_2">
                                                         ...
                                                         <input type="hidden" name="function_name" value="outerbox_pack_without_ib">
      ...
      $("#packing_wt_mtr_new").live('keyup', function ()
      {
         ...
         if($(this).val() > 0)
         {
            $("#packing_tot_mtr").val(packing_net_weight / $(this).val());
         }
         else
         {
            var packing_wt_mtr = $("#packing_wt_mtr").val();
            $("#packing_tot_mtr").val(packing_net_weight / packing_wt_mtr);
         }
      });
      ...
      $("input.weight").live('keyup', function ()
      {
         ...
         $("#packing_net_weight").val(netweight.toFixed(3));
      });
      ...
      <script>
      $(document).ready(function() {
         $("#sav_but").click(function(event){
            if( $("#packing_net_weight").val() <= 1)
            {
               alert("Error in NetWeight");
