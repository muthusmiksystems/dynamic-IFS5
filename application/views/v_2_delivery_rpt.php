   ...
   <body>
                  ...
                  <div class="col-lg-12">
                     <section class="panel">
                        <header class="panel-heading">
                           <h3><i class="icon-map-marker"></i> Deliveries</h3>
                        </header>
                     </section>
                  </div>
               </div>
                          ...
                          <div class="panel-body">
                              ...
                              <thead>
                                <tr>
                                  <th width="2%">#</th>
                                  <th width="10%">Date</th>
                                  <th width="5%">Pre Delivery No</th>
                                  <th width="10%">DC #</th>
                                  <th width="13%">Customer</th>
                                  <th width="50%">Selected Boxes</th>
                                  <th width="10%"></th>
                                </tr>
                              </thead>
                              <tbody>
                                ...
                                foreach ($deliveries as $row) {
                                  ...
                                  <tr>
                                    ...
                                    <td><?=$row['p_delivery_ref']; ?></td>
                                    <td><?=$row['dc_no']; ?></td>
                                    <td>
                                      <?=$this->m_masters->getmasterIDvalue('bud_customers', 'cust_id', $row['delivery_customer'], 'cust_name');?>
                                    </td>
                                    <td><?=implode(",", $delivery_boxes); ?></td>
                                    <td>
                                      <a href="<?=base_url(); ?>production/delivery_2_print/<?=$row['delivery_id']; ?>" class="btn btn-success btn-xs">Print</a>
      ...
      <script>
        ...
        function deletedc(){
          ...
          var url = "<?php echo base_url('production/delivery_2_delete')?>";
          $.ajax({
              type: "POST",
              url: url,
              data:  {
