                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                <h3><i class="icon-book"></i> Job Inwards</h3>
                            </header>
                        </section>
                    </div>
                </div>
                        ...
                        <table class="table table-striped border-top" id="sample_1">
                          ...
                          foreach ($jobinwards as $jobinward) {
                            ...
                            <tr>
                                ...
                                <td>
                                  <?=$this->m_masters->getmasterIDvalue('bud_categories', 'category_id', $jobinward['job_category'], 'category_name'); ?>
                                </td>
                                <td class="">
                                  <?=$this->m_masters->getmasterIDvalue('bud_customers', 'cust_category', $jobinward['job_customer'], 'cust_name'); ?>
                                </td>
                                <td class="">
                                  <?=$jobinward['job_remarks']; ?>
                                </td>
                                <td>
                                  <?=$this->m_purchase->getJobTotalQty($job_enq_id); ?>
                                </td>
                                <!-- <td>
                                  <a href="#" data-placement="top" data-original-title="View" data-toggle="tooltip" class="btn btn-success btn-xs tooltips"><i class="icon-file-text"></i></a>
