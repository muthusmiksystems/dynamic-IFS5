         ...
         <section id="main-content">
            <section class="wrapper">
              ...
              // $customers = $this->m_masters->getactivemaster('bud_customers', 'cust_status');           
               ?>
               <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>Mir_reports/item_pack_report_1">
                  <div class="row">
                     <div class="col-lg-12">
                        <section class="panel">                            
                           <header class="panel-heading">
                           ...
                           <table id="example" class="datatable table table-bordered table-striped table-condensed cf packing-register">
                              <thead>
                                 <tr>
                                    ...
                                    <th color='red'><strong><?=$grand_tot_cones; ?></strong></th>
                                 ...
                                 <tr>
                                    ...
                                    <th color='red'><strong><?=$tot_cones; ?></strong></th>
                                    <th color='red'><strong><?=$tot_wt; ?></strong></th>
                                 </tr>
                                 <tr>
                                    <th>#</th>  
      						            <th>Term</th>
                              ...
                              <?php
                                 ...
                                 if($item!=0)
                                 {
                                    $items=$this->m_masters->getcustomerdetails($item);
                                 }
                                 foreach ($items as $item1) {
                                    ...
                                    if($end_value>$month_value)
                                    {
                                       ...
                                       {
                                          if($pk_wt[$item1['item_id']][$month_value]!=0)
                                          {
                                          ?>
                                          <tr>
                                             <td><?=$sno; ?></td>
                                             <td><?=date($m_or_y,strtotime('01-'.($month_value>12)?'1':$month_value.'-'.$year_value));?></td>
                                             <td><?=$item1['item_name'].' / '.$item1['item_id']; ?></td>
                                             <td><?=$pk_cone[$item1['item_id']][$month_value];?></td>
                                             <td><?=$pk_wt[$item1['item_id']][$month_value];?></td>
                                          </tr>
                                          <?php
                                          $sno++;
                                          }
