      ...
      <section id="container" class="">
         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>Mir_reports/item_sales_report_2">
                  <div class="row">
                     <div class="col-lg-12">
                        <section class="panel">                            
                           <header class="panel-heading">
                           ...
                           <table id="example" class="datatable table table-bordered table-striped table-condensed cf packing-register">
                              <thead>
                                 ...
                                 <tr>
                                    ...
                                    <th style="color:'red';"><strong>Total:<strong></th>
                                       <th color='red'><strong><?=array_sum($item_detail['tot_inv_num']); ?></strong></th>
                                    <th></th>
                                    <th color='red'><strong><?=$item_detail['tot_inv_rate']; ?></strong></th>
                                 </tr>
                                 <tr>
                                    <th>#</th>  
                                    <th>Term</th>
                              ...
                              <?php
                                 $sno=1;
                                    ...
                                    if(($item_id=='grand_tot')||($item_id=='tot_inv_rate')||($item_id=='tot_inv_num'))
                                       continue;
                                    ...
                                    ?>
                                       <tr>
                                          ...
                                          <td><?=$item_id;?></td>
                                          <td><?=$term;?></td> 
                                          <td><?=array_sum($term_value['inv_num']);?></td> 
                                          <td><?php
                                          $rate=0;
                                          foreach ($term_value as $uom=>$uom_value) {
                                             if($uom!='inv_num')
                                             {
                                                $rate+=array_sum($uom_value['item_rate']); 
                                                echo array_sum($uom_value['item_wt']).'-'.$uom.','; 
                                             }  
                                          }?>
                                          </td>
                                          <td><?=$rate;?></td>
