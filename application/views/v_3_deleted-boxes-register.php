         ...
         <section id="main-content">
            <section class="wrapper">
                  ...
                  <div class="col-lg-12">
                     <section class="panel">
                        <header class="panel-heading">
                           <h3><i class=" icon-file"></i>  Deleted Box Register</h3>
                        </header>
                     </section>
                  </div>
               </div>
               ...
               $items = $this->m_masters->getactivemaster('bud_lbl_items', 'item_status');
                      ?>
               <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>reports/deletedboxRegister_3">
                  <div class="row">
                     <div class="col-lg-12">
                        <section class="panel">                                               <header class="panel-heading">
                           ...
                           <div class="panel-body">
                              ...
                              <div class="form-group col-lg-3">
                                 ...
                                 <select class="form-control select2 item" id="item_id" name="item_id" name="item_id">
               ...
               <div class="col-lg-12">
                  <!-- Start Talbe List  -->                                  <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        ?>
                        <h3 class="visible-print">Deleted Boxes Register (Labels)</h3>
                        <div class="col-sm-6">
