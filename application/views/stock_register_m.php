   ...
   <section id="container" class="">
      ...
      <section id="main-content">
         <section class="wrapper">
               ...
               <div class="col-lg-12">
                  <section class="panel">
                     <header class="panel-heading">
                        <h3><i class=" icon-file"></i> Stock Register (AS ON)</h3>
                     </header>
                  </section>
               </div>
            </div>
            ...
            ?>
            <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?= base_url() ?>reports/stock_register_m">
               <div class="row">
                  <div class="col-lg-12">
                     <section class="panel">
                        <header class="panel-heading">
                           Stock Register (AS ON)
                        </header>
                        ...
                        ?>
                           <div class="">
                              <div class="col-md-12" align="center">
                                 ...
                                 <strong>Search Date : </strong> <?= $f_date; ?> &nbsp;&nbsp;
