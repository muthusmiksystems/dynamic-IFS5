            ...
            <section class="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        ?>
                        <form class="cmxform form-horizontal tasi-form" role="form" id="commentForm" method="post" action="<?= base_url(); ?>masters/stockmanager_save">
                            <section class="panel">
                                <header class="panel-heading">
                                    Stock Room Details
                                </header>
                                <div class="panel-body">
                                    ...
                                    <div class="form-group col-lg-12 contacts">
                                        ...
                                        <div class="form-group col-lg-12">
                                            ...
                                            <div class="col-lg-3">
                                                Blocks <label class="countBlocks">1</label>
                                            </div>
                                        </div>
                                        <div class="form-group col-lg-12 contactsrow">
                                            ...
                                            <div class="form-group col-lg-6 contacts2">
                                                <div class="form-group col-lg-12">
                                                    <div class="col-lg-9">
                                                        <button type="button" class="btn btn-primary addrow2"><i class="icon-plus"></i> Add</button>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        Rack <label class="countRacks">1</label>
                                                    </div>
                                                </div>
                                                <div class="form-group col-lg-12 contactsrow2">
                                                    <div class="col-lg-6">
                                                        <input class="form-control" value="Rack" name="rack[]" type="text">
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <input class="form-control" value="20" name="rack_sizes[]" type="text">
                                                    </div>
                                                    <div class="col-lg-3">
    ...
    <script>
        ...
        $(document).ready(function() {
            $(document).on("click", '.addrow', function() {
                var nextrow = '<div class="form-group col-lg-12 contactsrow"><div class="col-lg-3"><input class="form-control" value="Block" name="blocks[]" type="text"></div><div class="col-lg-3"><button type="button" class="btn btn-danger removerow"><i class="icon-minus"></i> Remove</button></div><div class="form-group col-lg-6" id="contacts2"><div class="form-group col-lg-12"><div class="col-lg-9"><button type="button" class="btn btn-primary addrow2"><i class="icon-plus"></i> Add</button></div><div class="col-lg-3">Rack <label class="countRacks">1</label></div></div><div class="form-group col-lg-12 contactsrow2"><div class="col-lg-6"><input class="form-control" value="Rack" name="rack[]" type="text"></div><div class="col-lg-3"><input class="form-control" value="20" name="rack_sizes[]" type="text"></div><div class="col-lg-3"><button type="button" class="btn btn-danger removerow2"><i class="icon-minus"></i> Remove</button></div></div></div></div>';
            ...
            $(document).on("click", '.addrow2', function() {
                var nextrow = '<div class="form-group col-lg-12 contactsrow2"><div class="col-lg-6"><input class="form-control" value="Rack" name="racks[]" type="text"></div><div class="col-lg-3"><input class="form-control" value="20" name="rack_sizes[]" type="text"></div><div class="col-lg-3"><button type="button" class="btn btn-danger removerow2"><i class="icon-minus"></i> Remove</button></div></div>';
