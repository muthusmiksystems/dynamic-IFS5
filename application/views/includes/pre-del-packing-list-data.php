    ...
    <tbody>
        ...
        <?php if (sizeof($boxes) > 0) : ?>
            <?php foreach ($boxes as $box) : ?>
                ...
                $tot_predc_qty = $this->m_masters->get_tot_field_value('bud_sh_predel_items', 'delivery_qty', array('box_id' => $box->box_id));
                $box->nt_weight;
                $bal_qty = $box->nt_weight - ($tot_predc_temp_qty + $tot_predc_qty);
                ...
                <?php if ($bal_qty > 0) : ?>
                    <tr>
                        ...
                        <td class="text-blue box-nt-wt">
                            <?php echo number_format($bal_qty, 3, '.', ''); ?>
                        </td>
