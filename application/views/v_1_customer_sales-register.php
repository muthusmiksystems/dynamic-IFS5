      ...
      <section id="container" class="">
         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>reports/cust_sales_register_1">
                  <div class="row">
                     <div class="col-lg-12">
               ...
               <div class="col-lg-12">
                  <!-- Start Talbe List  -->                                  <section class="panel">
                    <header class="panel-heading">
                        ...
                        <h3 class="visible-print">Customer Sales Register (Yarn &amp; Thread)</h3>
                        <div class="col-sm-6">
                           ...
                           <table id="example" class="datatable table table-bordered table-striped table-condensed cf packing-register">
                            <thead>                                                    <tr>
                              ...
                              $no_of_boxes = 0;
                              	...
                              	{
                              		$delivery = $this->m_delivery->get_yt_delivery($dc_no);
                              		if($delivery)
                              		{
