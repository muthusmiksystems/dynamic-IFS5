                        ...
                        <section class="panel">                            
                           ...
                           <div class="panel-body">
                              ...
                              <div class="form-group col-lg-3">
                                ...
                                <a href="<?=base_url();?>Mir_reports/dyeing_sent_items_1" class="btn btn-primary">back</a>
                              </div>                             
                           </div>
                        </section>
                     </div> 
                  ...
                  <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="col-md-4 text-right">
                           ...
                           <table id="example" class="datatable table table-bordered table-striped table-condensed">
                              <thead>
                                 <tr>
                                    <th></th>
                                    <th></th>
                              ...
                              <?php
                                 $sno = 1;
                                 foreach ($item_detail as $dcs => $dc_value) {
                                    if (empty($dcs)||($dcs=='tot_nweight')||($dcs=='tot_gweight')||($dcs=='tot_cones')||($dcs=='tot_boxes')) {
                                       continue;
                                    }
                                    ?>    
                                    <tr>
                                       <td><?=$sno; ?></td>
                                       <td><?=$dcs;?></td>
                                       <td><?=$dc_value['delivery_date']?></td>
                                       <td><?=$dc_value['item_name']?></td>
                                       <td><?=$dc_value['gross_weight']?></td>
                                       <td><?=$dc_value['net_weight']?></td>
                                       <td><?=$dc_value['no_of_cones']?></td>
                                       <td><?=$dc_value['no_of_boxes']?></td>
                                       <td width="50%"><?=$dc_value['box_num']?></td>
                                       <td><?=$dc_value['remarks']?></td>
                                    </tr>
                                 <?php
                                 $sno++;
                                 }
