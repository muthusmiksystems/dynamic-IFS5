                        ...
                        <table class="table table-striped border-top" id="sample_1">
                          ...
                          foreach ($enquiries as $enquiry) {
                            ...
                            <tr>
                                ...
                                <td>
                                  <a href="<?=base_url(); ?>purchase/newquotation/<?=$enquiry['enq_id']; ?>" data-placement="top" data-original-title="View" data-toggle="tooltip" class="btn btn-success btn-xs tooltips"><i class="icon-file-text"></i></a>
