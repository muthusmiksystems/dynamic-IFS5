                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                ?>                                                    <form class="cmxform form-horizontal tasi-form" role="form" method="post" action="<?=base_url('request_form/send_tax_email_lbl');?>">
  ...
  <script>
      ...
      $(function(){
        $("#cust_id").change(function () {
            ...
            var url = "<?=base_url()?>request_form/get_cust_invoice_lbl/"+cust_id;
      ...
      $(function(){
        $("#invoice_id").change(function () {
            ...
            var url = "<?=base_url()?>request_form/get_invoice_cust_lbl/"+invoice_id;
