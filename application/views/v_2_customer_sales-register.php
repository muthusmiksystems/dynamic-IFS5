      ...
      <section id="container" class="">
         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>reports/cust_sales_register_2">
                  <div class="row">
                     <div class="col-lg-12">
               ...
               <div class="col-lg-12">
                  <!-- Start Talbe List  -->                                  <section class="panel">
                    <header class="panel-heading">
                        ...
                        <h3 class="visible-print">Customer Sales Register (Tapes &amp; Elastic)</h3>
                        <div class="col-sm-6">
                           ...
                           <table id="example" class="datatable table table-bordered table-striped table-condensed cf packing-register">
                            <thead>                                                    <tr>
                              ...
                              $dc_nos = array();
                              	...
                              	{
                              		$delivery = $this->m_delivery->get_te_delivery($dc_no);
                              		if($delivery)
                              		{
