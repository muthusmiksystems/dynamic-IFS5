   ...
   <section id="container" class="">
      ...
      <section id="main-content">
         <section class="wrapper">
               ...
               <div class="col-lg-12">
                  <section class="panel">
                     <header class="panel-heading">
                        <h3><i class=" icon-file-text"></i> Estimate Preview</h3>
                     </header>
                  </section>
               </div>
            </div>
            ...
            $no_cones_arr = array();
            $rates_arr = array();
            $invoice_details = $this->m_masters->getmasterdetails('bud_yt_proforma_invoices', 'invoice_id', $invoice_id);
                     ...
                     <div class="panel-body">
                        <table class="table table-bordered table-striped table-condensed invoice-table">
                           <tbody>
                              ...
                              <tr>
                                 <td colspan="7">
                                    <strong style="font-size:18px;">P.I No</strong>&emsp;
                              ...
                              ?>
                                    <tr>
                                       ...
                                       <td><?= $nt_weights_arr[$key_1] * $rates_arr[$key_1]; ?></td>
                                    </tr>
                                 <?php
                                    $sno++;
                                    $total_items++;
                                 ...
                                 <td colspan="10">
                                    <div class="col-lg-12">
                                       ...
                                       <div class="print-div right-align col-lg-3">
                                          <strong>For <?= $concern_title; ?>.</strong>
                                          <br />
                                          <br />
                                          <br />
                                          <br />
