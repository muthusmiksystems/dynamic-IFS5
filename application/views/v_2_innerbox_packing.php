      ...
      <section id="container" class="">
         ...
         <section id="main-content">
            <section class="wrapper">
                  ...
                  <div class="col-lg-12">
                     <section class="panel">
                        <header class="panel-heading">
                           <h3 style=""><i class="icon-dropbox"></i> Inner Box Packing (Rolls)</h3>
                        </header>
               ...
               </div>                      <form class="cmxform form-horizontal tasi-form packing-form" role="form" id="commentForm" method="post" action="<?=base_url();?>production/innerbox_packing_save">                            <input type="hidden" name="packing_type" value="rolls">
                  <div class="row">
                     <div class="col-lg-12">
                           ...
                           <div class="panel-body">
                              ...
                              <div class="col-lg-5">
                                 ...
                                 <div class="form-group">
                                  ...
                                  <div class="form-group">
                                	 <label for="lot_no">Lot No </label>                                                      	 <input type="text" name="lot_no" id="lot_no" class="form-control" required />
                              </div>
                              ...
                              <div class="col-lg-3">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <select class="select2 form-control" data-placeholder="Select Operator" readonly="readonly" tabindex="11" name="packing_by" id="packing_by" required >                                                                  <?php
                                 ...
                                 <div class="form-group">
                                    ...
                                    <select class="select2 form-control" id="packing_stock_room" name="packing_stock_room" tabindex="12">
                           ...
                           <tr>
                              ...
                              <td>
                              	<?php	  
	                              	foreach ($colors as $row) 
	                              	{
		                              	 if($row['shade_id'] == $innerbox['shade_id'])
		                              	 {
		                              	 	echo $row['shade_name'];		                              	 	
		                              	 }
	                              	}                                                          
                              ...
                              <td><?=$innerbox['shade_id'];?></td>
                              <td ><?=number_format($innerbox['packing_tot_mtr'], 2, '.', ''); ?></td>
                              <td ><?=$innerbox['packing_gr_weight']; ?></td>
                                                 <td ><?php if(!empty($innerbox['packing_net_weight'])){echo number_format($innerbox['packing_net_weight'], 3, '.', ',');} ?></td>
                                          <td>
                                    <?php
                                    	$this->db->select('*');
                              ...
                              <td>
                                 <a href="<?=base_url(); ?>production/innerbox_packing/<?=$innerbox['box_no']; ?>" data-placement="top" data-original-title="Duplicate" data-toggle="tooltip" class="btn btn-success btn-xs tooltips">Duplicate</a>
                                 <a href="<?=base_url(); ?>production/print_i_packing_slip/<?=$innerbox['box_no']; ?>" target="_blank" data-placement="top" data-original-title="Print" data-toggle="tooltip" class="btn btn-primary btn-xs tooltips">Print</a>
                              </td>
                                                 </tr>
                           <?php
                           $sno++;
