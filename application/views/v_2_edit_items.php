                        ...
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                foreach ($items as $item) {
                                  ...
                                  $hsn = $item['hsn_code'];
$item_uom = $item['item_umo'];
                                }
                                ?>
                                <form class="cmxform form-horizontal tasi-form" enctype="multipart/form-data" role="form" id="commentForm" method="post" action="<?=base_url();?>masters/items_2_update">                                                                <input type="hidden" name="item_id" value="<?=$item_id; ?>">                                                                <input type="hidden" name="item_category" value="<?=$item_category; ?>">                                                                <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <div class="col-lg-10">
                                          <input class="dateplugin form-control" value="<?=date('d-m-Y'); ?>" id="item_created_on" name="item_created_on" type="text" >                                                                                                                     </div>
                                    </div>
                                    <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <div class="col-lg-10">
                                          <input class="form-control" id="item_name" name="item_name" value="<?=$item_name; ?>" type="text" >
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label for="item_second_name" class="control-label col-lg-2">Item Second Name</label>
                                        <div class="col-lg-10">
                                          <input class="form-control" id="item_second_name" name="item_second_name" value="<?=$item_second_name; ?>" type="text" >                                                                                                                     </div>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label for="item_third_name" class="control-label col-lg-2">Item Third Name</label>
                                        <div class="col-lg-10">
                                          <input class="form-control" id="item_third_name" name="item_third_name" value="<?=$item_third_name; ?>" type="text" >                                                                                                                     </div>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label for="item_tax" class="control-label col-lg-2">Tax</label>
                                        <div class="col-lg-10">
                                          <input class="form-control" id="item_tax" name="item_tax" value="<?=$item_tax; ?>" type="text" >
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label for="item_tax" class="control-label col-lg-2">Rate</label>
                                        <div class="col-lg-10">
                                     ...
                                     <div class="form-group col-lg-12">
                                        ...
                                        <div class="col-lg-10">
                                          <input class="form-control" id="hsn" name="hsn" value="<?=$hsn; ?>" type="text" >                                                                                                                     </div>
                                    </div>
                                    <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <div class="col-lg-10">
                                          <input class="form-control" id="item_width" name="item_width" value="<?=$item_width; ?>" type="text" >                                                                                                                     </div>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label for="total_metrs" class="control-label col-lg-2">Total Meters</label>
                                        <div class="col-lg-10">
                                          <input class="form-control" value="<?=$total_metrs; ?>" id="total_metrs" name="total_metrs" type="text" >                                                                                                                     </div>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label for="total_weight" class="control-label col-lg-2">Total Weight (grams)</label>
                                        <div class="col-lg-10">
                                          <input class="form-control" value="<?=$total_weight; ?>" id="total_weight" name="total_weight" type="text" >                                                                                                                     </div>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label for="item_weight_mtr" class="control-label col-lg-2">Weight/Meter (grams)</label>
                                        <div class="col-lg-10">
                                          <input class="form-control" id="item_weight_mtr" name="item_weight_mtr" value="<?=$item_weight_mtr; ?>" type="text" >                                                                                                                     </div>
