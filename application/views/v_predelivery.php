                      ...
                      <!-- Start Talbe List  -->                                      <section class="panel">
                        ...
                        <table class="table table-striped border-top">
                          ...
                          foreach ($boxes as $box) {
                            ...
                            ?>
                            <tr>
                                <td><?=$sno; ?></td>                                                        <td><?=$box_id; ?></td>                                                        <td><?=$box_date; ?></td>                                                        <td><?=$box_customer_name; ?></td>                                                        <td><?=$enq_item_name; ?></td>                                                        <td><?=$box_grossweight; ?></td>                                                        <td><?=$box_tareweight; ?></td>                                                        <td><?=$box_netweight; ?></td> 
                                <td>
                                  <input type="checkbox" name="selected_boxes[]" value="<?=$box_id; ?>">
                                </td>                                                   </tr>
                            <?php
                            $sno++;
                          }
