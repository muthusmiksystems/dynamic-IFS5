  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                <h3><i class="icon-book"></i> Cash Receipt</h3>
                            </header>
                        </section>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                      <form class="cmxform form-horizontal tasi-form" role="form" id="commentForm" method="post" action="<?=base_url(); ?>accounts/savecashreceipt">                                        <section class="panel">                                                <header class="panel-heading">
                                Details
                            </header>
