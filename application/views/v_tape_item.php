                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                ?>                                                                                      <form class="cmxform form-horizontal tasi-form" enctype="multipart/form-data" role="form" id="commentForm" method="post" action="<?=base_url();?>masters/items_tape_save">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <div class="col-lg-10">
                                          <input class="form-control" id="item_name" name="item_name" type="text" required>                                                                                                                     </div>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label for="item_second_name" class="control-label col-lg-2">Item Second Name</label>
                                        <div class="col-lg-10">
                                          <input class="form-control" id="item_second_name" name="item_second_name" type="text" required>                                                                                                                     </div>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label for="item_third_name" class="control-label col-lg-2">Item Third Name</label>
                                        <div class="col-lg-10">
                                          <input class="form-control" id="item_third_name" name="item_third_name" type="text" required>                                                                                                                     </div>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label for="item_third_name" class="control-label col-lg-2">HSN Code</label>
                                        <div class="col-lg-10">
                                          <input class="form-control" id="hsn" name="hsn" type="number" required pattern="([1-9])+(?:-?\d){8,8}">                                                                                                                     </div>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label for="item_width" class="control-label col-lg-2">Item Width</label>
                                        <div class="col-lg-10">
                                          <input class="form-control" id="item_width" name="item_width" type="text" required>                                                                                                                     </div>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label for="total_metrs" class="control-label col-lg-2">Total Meters</label>
                                        <div class="col-lg-10">
                                          <input class="form-control" id="total_metrs" name="total_metrs" type="text" required>                                                                                                                     </div>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label for="total_weight" class="control-label col-lg-2">Total Weight (grams)</label>
                                        <div class="col-lg-10">
                                          <input class="form-control" id="total_weight" name="total_weight" type="text" required>                                                                                                                     </div>
                                    </div>
                                    <div class="form-group col-lg-12">
                                        <label for="item_weight_mtr" class="control-label col-lg-2">Weight/Meter (grams)</label>
                                        <div class="col-lg-10">
                                          <input class="form-control" id="item_weight_mtr" name="item_weight_mtr" type="text" required>                                                                                                                     </div>
                            ...
                            <tbody>
                              ...
                              foreach ($items as $item) {
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                                                    <a href="<?=base_url();?>masters/edititems_tape/<?=$item['item_id']?>" data-placement="top" data-original-title="Edit" data-toggle="tooltip" class="btn btn-primary btn-xs tooltips"><i class="icon-pencil"></i></a>
                                      <a href="<?=base_url();?>masters/deletemaster/bud_quote_tape/item_id/<?=$item['item_id']?>/masters/itemgroups_2" data-placement="top" data-original-title="Delete" data-toggle="tooltip" class="btn btn-danger btn-xs tooltips delete-user"><i class="icon-trash "></i></a>
                                    </td>
                                </tr>
                                <?php
                                $sno++;
