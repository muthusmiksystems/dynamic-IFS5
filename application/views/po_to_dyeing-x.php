                        ...
                        <section class="panel">
                            <div class="panel-body">
                                ...
                                <div class="form-group col-lg-2">
                                   <label for="po_qty">PO Ref. Name</label>
                                   <input type="text" class="form-control" id="po_person" name="po_person">
                                </div>
                                <div class="form-group col-lg-2">
                                   <label for="po_qty">PO Ref. Number</label>
                                ...
                                <div class="form-group col-lg-5">
                                   ...
                                   <textarea cols="70" rows="3" name="remarks"></textarea>
                                </div>
                        ...
                        <table class="table table-striped border-top" id="sample_1">
                          ...
                          <tbody>
                            ...
                            foreach ($table as $row) {
                                ...
                                <tr class="odd gradeX">
                                    <td><?=$sno; ?></td>
                                    <td><?=$row['R_po_no']; ?></td>                                                             <td><?=$row['date']; ?></td>                                                             <td><?=$row['cust_name']; ?></td>                                                             <td><?=$row['c_name']." - ".$row['c_tel']; ?></td> 
									<td><?=$row['user']; ?></td>                                 
									<td><?=$row['remark']; ?></td>                           
									<!-- 
                                    <td>
