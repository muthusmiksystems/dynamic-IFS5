      ...
      <section id="container" class="">
         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>Mir_reports/item_sales_report_3">
                  <div class="row">
                     <div class="col-lg-12">
                        <section class="panel">                            
                           <header class="panel-heading">
                           ...
                           <table id="example" class="datatable table table-bordered table-striped table-condensed cf packing-register">
                              <thead>
                                 <tr>
                                    ...
                                    <th><strong color='red'><?php echo count($grand_item_detail['tot_invs']); ?></strong></th>
                                    <th></th>
                                    <th><strong color='red'><?php echo $grand_item_detail['tot_inv_wt']; ?></strong></th>
                                    <th><strong color='red'><?php echo $grand_item_detail['tot_inv_price']; ?></strong></th>
                                 </tr>
                                 <tr>
                                    <th></th>
                                    <th></th>
                                    <th></th>
                                    <th><strong color='red'>Total:<strong></th>
                                    <th><strong color='red'><?php echo count($item_detail['tot_invs']); ?></strong></th>
                                    <th></th>
                                    <th><strong color='red'><?php echo $item_detail['tot_inv_wt']; ?></strong></th>
                                    <th><strong color='red'><?php echo $item_detail['tot_inv_price']; ?></strong></th>
                                 </tr>
                                 <tr>
                                    <th>#</th>  
                                    <th>Term</th>
                                    ...
                                    <th># Invoices</th>
                                    <th>Invoices</th>
                                    <th>Inv. Item Tot Qty</th>
                                    <th>Inv. Item Tot Price (Before Tax)</th>
                                 </tr>
                              </thead>
                              <tfoot>
                                <tr>
                              ...
                              <?php
                                 ...
                                 foreach ($item_detail as $item_id=>$item_value) {
                                    if(($item_id=='tot_inv_wt')||($item_id=='tot_invs')||($item_id=='tot_inv_price'))
                                    {
                                       continue;
                                    }
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          <?php 
                                          echo '['.sizeof($term_value['cust_name']).']-';
                                          foreach ($term_value['cust_name'] as $cust_id =>$item_rate) {
                                             ?>
                                             <?=$item_rate.',';?>
                                             <?php
                                          } 
                                       ...
                                       <td><?=array_sum($term_value['inv_price']);?></td>
                                    </tr>
                                    <?php
                                    $sno++;
                                    }
