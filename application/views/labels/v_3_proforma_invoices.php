                                 ...
                                 <tbody>
                                    ...
                                    foreach ($proforma_invoices as $row) {
                                       ...
                                       <tr>
                                          ...
                                          <td>
                                             <a href="<?=base_url(); ?>sales/print_trans_invoice_3/<?=$row['invoice_id']; ?>/1" data-placement="top" data-original-title="Print Transport Invoice" data-toggle="tooltip" class="btn btn-success btn-xs tooltips">Print Transport Invoice</a>
                                              <a href="<?=base_url(); ?>sales/print_gatepass_3/<?=$row['invoice_id']; ?>/1" data-placement="top" data-original-title="Print Gatepass" data-toggle="tooltip" class="btn btn-success btn-xs tooltips">Print Gatepass</a>
                                             <a href="<?=base_url(); ?>sales/proforma_invoice_3/<?=$row['invoice_id']; ?>" data-placement="top" data-original-title="Print Proforma Invoice" data-toggle="tooltip" class="btn btn-success btn-xs tooltips">Print Proforma Invoice</a>
