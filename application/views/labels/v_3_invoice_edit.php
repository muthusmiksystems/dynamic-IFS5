   ...
   <section id="container" class="">
      ...
      <section id="main-content">
         <section class="wrapper">
            ...
            // print_r($tax_values);
            ?>
            <form class="cmxform form-horizontal tasi-form" role="form" id="commentForm" method="post" action="<?= base_url(); ?>sales/invoice_3_update">
                              ...
                              <tbody>
                                 ...
                                 ?>
                                    <tr>
                                       ...
                                       <td>
                                          <input type="hidden" name="invoice_items[<?= $value; ?>][<?= $item_size_array[$key]; ?>]" value="<?= $item_qty_array[$key]; ?>">
                                          <input type="hidden" name="item_boxes[<?= $value; ?>]" value="<?= $item_boxes_array[$key]; ?>">
                                          <input type="hidden" name="item_uom[<?= $value; ?>]" value="<?= $item_uom_array[$key]; ?>">
                                          <input type="text" name="item_rates[<?= $value; ?>]" value="<?= $item_rate_array[$key]; ?>" style="width:100%;">
                                       </td>
                                 ...
                                 ?>
                                    <tr>
                                       <td colspan="3">
                                          <strong>DC No: &emsp;<?= implode(",", $invoice_dc); ?></strong>
                                       </td>
                                       <td colspan="5">
                                          <strong>B.NO: <?= implode(",", $boxes_array); ?></strong>
                                       </td>
                                    </tr>
                                 <?php
                                 }
