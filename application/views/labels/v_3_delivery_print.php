            ...
            <section class="wrapper">
               ...
               <div class="row">
                  ...
                  foreach ($delivery_details as $row) {
                    ...
                    $p_delivery_id = $row['p_delivery_ref'];//partial delivery qty
                  ...
                  foreach ($InvoiceItems as $item) {
                    ...
                    $item_sizes_array[$box_no][$item_size] = $total_qty;//partial delivery qty
                                  ...
                                  <tr>
                                    <th colspan="4">
                                      ...
                                      <?php if($concern): ?>
                                        ...
                                        GST: <?php echo $concern->concern_gst; //partial delivery qty?><br>
                                      <?php endif; ?>
                                    </th>
                                    <th colspan="3">
                                      <strong>TO:</strong><br/>
                                      <?php if($customer): ?>
                                        ...
                                        GST: <?php echo $customer->cust_gst; //partial delivery qty?><br>
                                      <?php endif; ?>
                                    </th>
                                  </tr>
                                  <tr>
                               ...
                               <tbody>
                                  ...
                                  foreach ($item_sizes_array as $key => $sizes) {
                                    ...
                                    <td style="text-align:left;">
                                      <?php
                                      foreach ($sizes as $size_key => $value) {
                                        $total_item_qty += $value;//partial delivery qty
                                        echo $size_key.'='.$value.',';//partial delivery qty
                                      }
                     ...
                     <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                For Making Invoice go to <strong>Sales->Create Invoice</strong>
                            </header>
                        </section>
                     </div>
                  </div>
