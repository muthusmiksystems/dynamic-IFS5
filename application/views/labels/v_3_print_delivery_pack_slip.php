...
<body>
	...
	foreach ($box_details as $row) {
		...
		$delivery_qty= $this->m_mir->total_values('bud_lbl_predelivery_items',null,'delivery_qty',null,null,array('delivery_id'=>$delivery_id,'p_delivery_is_deleted'=>'1','box_id'=>$box_no,'item_size'=>$item_size));
		$items_array[$item_size][] =$delivery_qty;
		$rolls_array[$item_size][] = $row['packed_no_rolls'];
		$total_qty += $delivery_qty;
