   ...
   <body>
                              ...
                              <table id="sample_1" class="table table-bordered table-striped table-condensed">
                                 <thead>
                                    <tr>
                                       ...
                                       <th width="10%">Date</th><!--Inclusion of DLC Date-->
                                 ...
                                 <tbody>
                                    ...
                                    foreach ($proforma_invoices as $row) {
                                       ...
                                       <tr>
                                          ...
                                          <td><?=date('d-M-y',strtotime($row['invoice_date'])); ?></td><!--Inclusion of Invoice Date-->
                                          <td><?=$this->m_masters->getmasterIDvalue('bud_customers', 'cust_id', $row['customer'], 'cust_name');?><br/></td>
                                          <td><?=array_sum($item_qty_array); ?></td>
                                          <td><?=number_format($net_amount, 2, '.', ''); ?></td>
                                          <td><?=$concern_name; ?></td>
                                          <td><?=$this->m_masters->getmasterIDvalue('bud_users', 'ID', $prepared_by, 'user_login'); ?><br/></td>
                                          <td>
                                             <a href="<?=base_url(); ?>sales/print_trans_invoice_3/<?=$row['invoice_id']; ?>/2" data-placement="top" data-original-title="Print Transport Invoice" data-toggle="tooltip" class="btn btn-success btn-xs tooltips">Print Transport Invoice</a>
                                             <a href="<?=base_url(); ?>sales/print_gatepass_3/<?=$row['invoice_id']; ?>/2" data-placement="top" data-original-title="Print Gatepass" data-toggle="tooltip" class="btn btn-success btn-xs tooltips">Print Gatepass</a>
                                             <a target="_blank" href="<?=base_url(); ?>sales/invoice_3_preprint/<?=$row['invoice_id']; ?>/2" data-placement="top" data-original-title="Print Pre-printed" data-toggle="tooltip" class="btn btn-success btn-xs tooltips">Print Pre-printed</a>
                                             <?php
                                             // if($concern_name == 'ESTIMATE')
                                             if($lr_no != '' || $concern_name == 'ESTIMATE')
                                             {
                                                ?>
                                                <a href="<?=base_url(); ?>sales/invoice_3_view/<?=$row['invoice_id']; ?>" data-placement="top" data-original-title="View" data-toggle="tooltip" class="btn btn-success btn-xs tooltips">View</a>
                                                   ...
                                                   <div class="modal-dialog">
                                                      <div class="modal-content">
                                                         ...
                                                         <div class="modal-body">
                                                            <form role="form" method="post" action="<?=base_url(); ?>sales/print_invoice_3">
                                             ...
                                             {
                                                ?>
                                                <a href="<?=base_url(); ?>sales/invoice_3_edit/<?=$row['invoice_id']; ?>" class="btn btn-danger btn-xs">Edit</a>
      ...
      <script>
        ...
        function deletedc(){
          ...
          var url = "<?php echo base_url('sales/delete_invoice_3')?>";
          $.ajax({
              type: "POST",
              url: url,
              data:  {
