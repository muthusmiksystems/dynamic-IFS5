...
<body>
   ...
   <section id="container" class="">
      ...
      <section id="main-content">
         <section class="wrapper">
            ...
            <form class="cmxform form-horizontal tasi-form" role="form" id="commentForm" method="post" action="<?= base_url(); ?>production/predelivery_3">
                     ...
                     <section class="panel">
                        ...
                        <div class="panel-body">
                           <div class="form-group col-lg-3">
                              ...
                              <input class="datepicker form-control" id="from_date" value="<?= date('d-m-Y'); ?>" name="from_date" type="text" required>
                           </div>
                           <div class="form-group col-lg-3">
                              <label for="to_date">To</label>
                              <input class="datepicker form-control" id="to_date" value="<?= date('d-m-Y'); ?>" name="to_date" type="text" required>
                           </div>
                           <div class="form-group col-lg-3">
            ...
            <?php
            $outerboxes = $this->m_production->lblPredelItemSearch($from_date, $to_date, $item_name);
            ?>
            <div class="row">
               <div class="col-lg-12">
                  <section class="panel">
                        ...
                        <table class="table table-striped border-top" id="sample_1">
                           ...
                           <tbody>
                              ...
                              foreach ($outerboxes as $row) {
                                 ...
                                 $bal_qty = round($row['SUM(`total_qty`)']) - round($delivered_qty);
                                 if ($bal_qty <= 0) {
                                    continue;
                                 }
                              ?>
                                 <tr>
                                    ...
                                    <td>
                                       <?= $bal_qty ?>
                                       <input type="hidden" class="total_meters" id="mtr_<?= $row['box_no']; ?>" value="<?= $bal_qty; ?>">
                                    </td>
                                    <td>
                                       <?= $packing_gr_weight; ?>
                                    ...
                                    <td>
                                       <?php
                                       if (($row['predelivery_status'] == 1) || ($bal_qty > 0)) {
                                       ?>
                                          <input class='checkedBox' type="checkbox" name="outer_boxes[]" class="checkbox" value="<?= $row['box_no']; ?>">
                                       <?php
                                       } else {
                                       ...
                                       if ($bal_qty < round($row['SUM(`total_qty`)'])) { ?>
                                          <button class="btn btn-danger btn-xs">O.B</button>
                                       <?php
                                       }
                                       ?>
                                    </td>
            ...
            <form class="cmxform form-horizontal tasi-form" role="form" id="commentForm" method="post" action="<?= base_url(); ?>production/predelivery_3_save">
               <div class="row">
                  <div class="col-lg-12">
                     <section class="panel">
                        <header class="panel-heading">
   ...
   <script>
      ...
      $("a.removeAll").live("click", function() {
         var url = "<?= base_url() ?>production/predelivery_3_removeAll";
