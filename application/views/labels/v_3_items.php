                            ...
                            <header class="panel-heading">
                                ...
                                if(isset($item_id))
                                {
                                  ...
                                  foreach ($result as $row) {
                                    ...
                                    $one_meter_weight = $row['one_meter_weight'];//ER-09-18#-62
                                  }
                                ...
                                else
                                {
                                  ...
                                  $item_sample = '';
                                  $one_meter_weight='';//ER-09-18#-62
                                }
                                ?>                                                                                      <form class="cmxform form-horizontal tasi-form" enctype="multipart/form-data" role="form" id="commentForm" method="post" action="<?=base_url();?>masters/save_item_3">
                                    ...
                                    <div class="form-group col-lg-12">
                                        ...
                                        <div class="col-lg-10">
                                          <input class="dateplugin form-control" value="<?=$item_created_on; ?>" id="item_created_on" name="formData[item_created_on]" type="text" required>
                                        </div>
                                    </div>
                                    <div class="form-group col-lg-12">
                                    ...
                                    <div class="form-group col-lg-6">
                                        <label for="item_width" class="control-label col-lg-4">Item Width</label>
                                        <div class="col-lg-8">
                                          <input class="form-control" value="<?=$item_width; ?>" id="item_width" name="formData[item_width]" type="text" required>
                                        </div>
                                    </div>
                                    <!--//ER-09-18#-62-->
                                    <div class="form-group col-lg-6">
                                        <label for="item_width" class="control-label col-lg-4">One Meter Weight</label>
                                        <div class="col-lg-8">
                                          <input class="form-control" value="<?=$one_meter_weight; ?>" id="one_meter_weight" name="formData[one_meter_weight]" type="text" required>
                                        </div>
                                    </div>
                                    <!--//ER-09-18#-62-->                                                            <div class="form-group col-lg-12">
                                    ...
                                    if($item_sample != '')
                                    {
                                      ...
                                      <div class="form-group col-lg-8">
                                        <img src="<?=base_url(); ?>uploads/itemsamples/labels/<?=$item_sample; ?>" style="width:auto;height:100px;max-width:100%;">
                                      </div>
                                      <?php
                                    }
                                    ?>
                            ...
                            <tbody>
                              ...
                              foreach ($items as $item) {
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td><?=$item['item_id']; ?></td>                                                                <td><?=$item['item_name']; ?></td>                                                                <td><?=$item['item_second_name']; ?></td>                                                                <td><?=$item['item_third_name']; ?></td>                                                         <td><?=$item['item_width']; ?></td>
                                                             <td><?=$item['weight_100_pcs']; ?></td>                                                                <td><?=sizeof($colorcombos); ?></td>                                                                <td>
                                    ...
                                    <td>
                                      ...
                                      <a href="<?=base_url();?>masters/items_3/<?=$item['item_id']?>" data-placement="top" data-original-title="Edit" data-toggle="tooltip" class="btn btn-primary btn-xs tooltips"><i class="icon-pencil"></i></a>
