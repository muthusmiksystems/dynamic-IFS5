                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                <h3><i class="icon-map-marker"></i> PO Received From Marketing</h3>
                            </header>
                        </section>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                ...
                                ?>                                                     <form class="cmxform form-horizontal tasi-form" role="form" id="commentForm" method="post" action="<?=base_url();?>purchase/save_po_received_3">
                                    <div class="form-group col-lg-3">
                                       <label for="item_name">Item Name</label>
                                       <input class="form-control" value="<?=date("d-m-Y"); ?>" id="po_date" name="po_date" type="text" readonly="">
                                    </div>
                                    <div class="form-group col-lg-3">
                                       <label for="item_name">Item Name</label>
                                    ...
                                    <div class="form-group col-lg-3">
                                       ...
                                       <select class="form-control select2" id="delivery_form" name="delivery_form">
                                          <option value="Roll Form">Roll Form</option>                                                                            <option value="Cut & Seal">Cut &amp; Seal</option>                                                                            <option value="Cut & Fold">Cut &amp; Fold</option>                                                                            <option value="Dye Cut">Dye Cut</option>                                                                         </select>
                                    </div>
                                    <div class="form-group col-lg-3">
                                            ...
                                            foreach ($item_sizes as $size) {
                                              if($size != '')
                                              {
                                                ...
                                                <tr>
                                                  <td><?=$sno; ?></td>
                                                  <td><?=$size; ?></td>
                                                  <td><input type="text" name="po_qty[<?=$size; ?>]"></td>
                                                  <td></td>
                                                </tr>
                                                <?php
                                                $sno++;                                                                                      }
                                    ...
                                    <div class="form-group col-lg-3">
                                       ...
                                       <input class="form-control" id="cust_old_balance" name="cust_old_balance" readonly="">
                                    </div>
                                    <div class="form-group col-lg-3">
                                       <label>Max. Days Pending</label>
                                       <input class="form-control" id="cust_old_balance" name="cust_old_balance" readonly="">
                                    </div>
                                    <div style="clear:both;"></div>
                                    <div class="form-group col-lg-12">
                              ...
                              foreach ($purchaseorders as $row) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      ?>
                                      <a href="<?=base_url(); ?>purchase/po_completed/<?=$row['po_no']; ?>" class="btn btn-warning btn-xs">Completed</a>
                                    </td>
                                </tr>
                                <?php
                                $sno++;
