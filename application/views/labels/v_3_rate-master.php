...
<html lang="en">
   ...
   <body>
            ...
            <section class="wrapper">
                  ...
                  <div class="col-lg-12">
                     <section class="panel">
                        <header class="panel-heading">
                           <h3><i class="icon-dropbox"></i> Item Rate Master</h3>
                        </header>
                     </section>
                  </div>
               </div>
               <div class="row">
                  ...
                  ?>
                      ...
                      <form class="cmxform form-horizontal tasi-form" role="form" id="commentForm" method="post" action="<?=base_url();?>admin/save_rate_master_3">
                  <div class="row">
                     <div class="col-lg-12">
      ...
      $(".get-item-retes").change(function(){
        ...
        var url = "<?=base_url()?>admin/getItemRetes_3";
