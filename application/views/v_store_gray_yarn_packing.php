      ...
      <section class="wrapper">
          ...
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
                <h3><i class="icon-book"></i> Gray & Dope Dyed Yarn Packing Entry</h3>
              </header>
              <?php
        ...
        if (isset($id)) {
          ...
          foreach ($result as $row) {
            ...
            $rno = $row['stock_room_id'];
            $item_id = $row['item_id'];
            $packed_item_id = $row['item_id'];
            $poy = $row['poy_denier'];
            ...
            $poy_inward_no_2 = $row['poy_inward_no_2'];
          }
        ...
        if (!empty($poy_inward_no_2)) {
          $poy_inward_2 = $this->m_poy->get_poy_inward($poy_inward_no_2);
          if (sizeof($poy_inward_2) > 0) {
            foreach ($poy_inward_2 as $row) {
              $inward_items_2 = $row->inward_items;

              if (sizeof($inward_items_2) > 0) {
                foreach ($inward_items_2 as $item) {
                  $inward_qty_2 += $item->po_qty;
                  $poy_denier_2 = $item->poy_denier;
                  $denier_name_2 = $item->denier_name;
                  $item_id_2 = $item->item_id;
                  $item_name_2 = $item->item_name;
                  $poy_lot_id_2 = $item->poy_lot_id;
                  $poy_lot_no_2 = $item->poy_lot_no;
                }
              }

              $supplier_name_2 = $row->group_name;
            }
          }
        }
        ?>
        <div class="row">
          <div class="col-lg-12">
            <form class="cmxform" role="form" id="commentForm" method="post" action="<?= base_url(); ?>store/gray_yarn_packing_save">
              <input type="hidden" name="id" value="<?= $id; ?>">
              <section class="panel">
                <header class="panel-heading">
                  <div class="form-group col-lg-12">
                    <label>Box No : </label>
                    <span class="label label-danger" style="padding: 0 1em;font-size:24px;">G<?= $box_no; ?></span>
                  </div>
                </header>
                <div class="panel-body">
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <span class="label label-primary" id="label_inward_qty" style="padding: 0 5px;font-size:24px;"><?= $inward_qty; ?></span>
                  </div>
                  <div class="form-group col-md-2">
                    <label for="po_date">Total Lot Packed Qty</label><br>
                    <span class="label label-warning" id="label_pack_qty" style="padding: 0 5px;font-size:24px;"><?= $tot_packed_qty; ?></span>
                  </div>
                  <div class="form-group col-md-2">
                    <label for="po_date">Balance Lot Qty</label><br>
                    <span class="label label-danger" id="label_bal_qty" style="padding: 0 5px;font-size:24px;"><?= $tot_balancd_qty; ?></span>
                  </div>
                  <div class="form-group col-md-1">
                    <label for="label_tot_wastage_qty">Wastage</label><br>
                    <span class="label label-danger" id="label_tot_wastage_qty" style="padding: 0 5px;font-size:24px;"><?= $tot_balancd_qty; ?></span>
                  </div>
                  <div class="form-group col-md-2">
                  ...
                  <div class="form-group col-md-1">
                    ...
                    <span class="label label-danger" id="label_percentage" style="padding: 0 5px;font-size:24px;"><?= number_format($percentage, 2, '.', ''); ?></span>
                  </div>
                  ...
                  <div class="form-group col-lg-2">
                    ...
                    <select class="form-control select2" name="" id="poy_denier_2">
                      ...
                      ?>
                        <option value="<?= $row->denier_id; ?>"><?= $row->denier_name; ?> / <?= $row->denier_id; ?></option>
                      <?php
                      }
                      ?>
                    </select>
                  ...
                  <div class="form-group col-md-2">
                    <label>Poy Inward No 2</label>
                    <select class="form-control select2" name="poy_inward_no_2" id="poy_inward_no_2">
                      <option value="">Select</option>
                      <?php
                      foreach ($poy_inwards as $row) {
                      ?>
                        <option value="<?php echo $row->po_no; ?>" <?= ($row->po_no == $poy_inward_no_2) ? 'selected="selected"' : ''; ?>><?php echo $row->po_no; ?></option>
                      <?php
                      }
                      ?>
                    </select>
                  ...
                  <div class="form-group col-md-6">
                    <table class="table table-bordered">
                      ...
                      <tbody>
                        <tr>
                          <td id="lbl_2_supplier_name"><?php echo $supplier_name_2; ?></td>
                          <td id="lbl_2_denier_name"><?php echo $denier_name_2; ?></td>
                          <td id="lbl_2_poy_lot_no"><?php echo $poy_lot_no_2; ?></td>
                          <td id="lbl_2_item_name"><?php echo $item_name_2; ?></td>
                          <td id="lbl_2_inw_qty"><?php echo $inward_qty_2; ?></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  ...
                  <div class="form-group col-md-2">
                    <label for="yarn_lot_id">Chandren Yarn Lot No <?= $yarn_lot_id; ?></label>
                  ...
                  <div class="form-group col-lg-2">
                    ...
                    <select class="item-select form-control select2" id="item_name" name="item_name">
                      ...
                      ?>
                        <option value="<?= $item['item_id']; ?>" <?= ($item['item_id'] == $packed_item_id) ? 'selected="selected"' : ''; ?>><?= $item['item_name']; ?></option>
                      <?php
                      }
                      ?>
                    </select>
                  ...
                  <div class="form-group col-lg-2">
                    ...
                    <select class="item-select form-control select2" id="item_id" name="item_id">
                      ...
                      foreach ($items as $item) {
                      ?>
                        <option value="<?= $item['item_id']; ?>" <?= ($item['item_id'] == $packed_item_id) ? 'selected="selected"' : ''; ?>><?= $item['item_id']; ?></option>
                      <?php
                      }
                      ?>
                    </select>
                  ...
                  <div class="form-group col-lg-2">
                    ...
                    <select class="form-control select2" name="yarn_denier" id="yarn_denier" required>
                      ...
                      ?>
                        <option value="<?= $row['denier_id']; ?>" <?= ($row['denier_id'] == $yarn_denier) ? 'selected="selected"' : ''; ?>><?php echo $row['denier_name']; ?></option>
                      <?php
                      }
                      ?>
                    </select>
                  ...
                  <!-- <div class="form-group col-lg-2">
                                <span class="text-danger">POY Lot No Link</span>
                              </div>
                              <div class="form-group col-lg-2">
                  ...
                  <div class="row col-md-12">
                    <div class="col-md-4">
                      <div class="form-group">
                        ...
                        <input class="form-control gross-weight" id="g_wt" name="g_wt" value="<?= $grant_wt; ?>" type="number" step="0.001" required onkeyup="tare_wt()">
                      </div>
                    </div>
                    <div class="col-md-8">
                  ...
                  <div class="form-group col-lg-4">
                    ...
                    <input class="form-control" name="spring_weight" id="spring_weight" value="<?= $spring_weight; ?>" type="text" required min="-1" onkeyup="tare_wt()">
                  </div>
                  <div class="form-group col-lg-4">
  ...
  <script>
    ...
    function tare_wt() {
      ...
      if (other >= 0) {
        if (grant >= 0) {
          if ((box >= 0) && (bag >= 0)) {
            var tare_total = box + bag + other + tot_cone_weight + spring_weight + tot_cone_weight_2;
            if (tare_total < grant) {
              $("#t_wt").val(tare_total);
      ...
      $("#poy_inward_no").change(function() {
        ...
        $.ajax({
          ...
          success: function(result) {
            ...
            //$("#yarn_lot_id").select2("", result.yarn_lot_id);
    ...
    $("#poy_inward_no_2").change(function() {
      var poy_inward_no_2 = $('#poy_inward_no_2').val();
      var url = "<?= base_url() ?>store/get_poy_inward_qty/" + poy_inward_no_2;
      var postData = 'poy_inward_no=' + poy_inward_no_2;
      $.ajax({
        type: "POST",
        url: url,
        // data: postData,
        success: function(result) {
          // console.log(result);
          var result = $.parseJSON(result);
          $("#lbl_2_supplier_name").text(result.supplier_name);
          $("#lbl_2_denier_name").text(result.denier_name);
          $("#lbl_2_item_name").text(result.item_name);
          $("#lbl_2_poy_lot_no").text(result.poy_lot_no);
          $("#lbl_2_inw_qty").text(result.inward_qty);
          $("#poy_denier_2").select2("val", result.poy_denier);
        }
      });
      return false;
    });
