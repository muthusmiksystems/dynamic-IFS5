      ...
      <section id="container" class="">
         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>Mir_reports/dyeing_sent_items_1">
                  <div class="row">
                     <div class="col-lg-12">
                        <section class="panel">                            
                           <header class="panel-heading">
                           ...
                           <table id="example" class="datatable table table-bordered table-striped table-condensed cf packing-register">
                              <thead>
                                 <tr>
                                    ...
                                    <th color='red'><strong><?=$grand_tot_gwt.' kgs'; ?></strong></th>
                                    <th color='red'><strong><?=$grand_tot_nwt.' kgs'; ?></strong></th>
                                    <th color='red'><strong><?=$grand_tot_boxes.' Boxes'; ?></strong></th>
                                    <th color='red'><strong><?=$grand_tot_cones.' Cones'; ?></strong></th>
                                    <th></th>
                                 ...
                                 <tr>
                                    ...
                                    <th color='red'><strong><?=$item_detail['tot_gweight'].' kgs'; ?></strong></th>
                                    <th color='red'><strong><?=$item_detail['tot_nweight'].' kgs'; ?></strong></th>
                                    <th color='red'><strong><?=$item_detail['tot_boxes'].' Boxes'; ?></strong></th>
                                    <th color='red'><strong><?=$item_detail['tot_cones'].' Cones'; ?></strong></th>
                                    <th></th>
                              ...
                              <?php
                                 $sno = 1;
                                 foreach ($item_detail['netweight'] as $item_ids => $items) {
                                    foreach ($items as $term_value => $netweight1) {
                                       ?>    
                                       <tr>
                                          <td><?=$sno; ?></td>
                                          <td><?=$item_detail[$item_ids]; ?></td>
                                          <td><?=$term_value;?></td>
                                          <td><?=$item_detail['grossweight'][$item_ids][$term_value]; ?></td>
                                          <td><?=$netweight1; ?></td>
                                          <td><?=$item_detail['numboxes'][$item_ids][$term_value]; ?></td>
                                          <td><?=$item_detail['numcones'][$item_ids][$term_value]; ?></td>
                                          <td><?=sizeof($item_detail['dcs'][$item_ids][$term_value]);?> - <a href="<?=base_url();?>Mir_reports/dyeing_sent_dcs_1/<?=$item_ids.'-'.$term_value.'-'.$term;?>" class="btn btn-primary btn-xs hidden-print">View</a></td>
                                       </tr>
                                    <?php
                                    $sno++;
                                    }
