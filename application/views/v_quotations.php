                        ...
                        <table class="table table-striped border-top" id="sample_1">
                          ...
                          foreach ($quotations as $quotation) {
                            ...
                            <tr>
                                ...
                                <td>
                                  <a href="<?=base_url(); ?>purchase/newpurchaseorder/<?=$quotation['quote_id']; ?>" data-placement="top" data-original-title="View" data-toggle="tooltip" class="btn btn-success btn-xs tooltips"><i class="icon-file-text"></i></a>
