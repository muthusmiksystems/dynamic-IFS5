  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                <h3><i class="icon-book"></i> Customer Opening Balance</h3>
                            </header>
                        </section>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                      <form class="cmxform form-horizontal tasi-form" role="form" id="commentForm" method="post" action="<?=base_url(); ?>accounts/savecustomeropenbalance">                                        <section class="panel">                                                <header class="panel-heading">
                                Details
                            </header>
  ...
  <script>
      ...
      $(function(){
        $("#payment_category").change(function () {
            ...
            var url = "<?=base_url()?>masters/getcustomerdatas/"+payment_category;
      ...
      $(function(){
        $("#payment_customer").change(function () {
            ...
            var url = "<?=base_url()?>accounts/customerpayements/"+payment_customer;
