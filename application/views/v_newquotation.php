      ...
      <section id="main-content">
          <section class="wrapper">
                ...
                foreach ($enquiries as $enquiry) {
                    ...
                    $enq_shade_no = $enquiry['enq_shade_no'];
                    $enq_lot_no = $enquiry['enq_lot_no'];
                    ...
                    $enq_shade_name = $this->m_masters->getmasterIDvalue('bud_shades', 'shade_id', $enq_shade_no, 'shade_name');
                    $enq_lot_name = $this->m_masters->getmasterIDvalue('bud_lots', 'lot_id', $enq_lot_no, 'lot_no');
                }
                ?>
                <div class="row">
                    <div class="col-lg-12">
                      <form class="cmxform form-horizontal tasi-form" role="form" id="commentForm" method="post" action="<?=base_url(); ?>purchase/savequotation">
                        <input type="hidden" name="enq_id" value="<?=$enq_id; ?>">
                        <input type="hidden" name="enq_category" value="<?=$enq_category; ?>">
