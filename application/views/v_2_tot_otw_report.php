      ...
      <section id="container" class="">
         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>Mir_reports/tot_otw_report_2">
                  <div class="row">
                     <div class="col-lg-12">
                        <section class="panel">                            
                           <header class="panel-heading">
                           ...
                           <table id="example" class="datatable table table-bordered table-striped table-condensed cf packing-register">
                              <thead>
                                <tr>
                                    ...
                                    <th><strong class='text-danger'><?=array_sum($item_detail['tot_pdc_nt_wt']).' Kg'; ?></strong></th>
                                    ...
                                    <th><strong class='text-danger'><?=array_sum($item_detail['tot_dc_nt_wt']).' Kg'; ?></strong></th>
                                    ...
                                    <th><strong class='text-danger'><?=array_sum($item_detail['tot_inv_nt_wt']).' Kgs'; ?></strong></th>
                                 ...
                                 <tr>
                                    ...
                                    <th colspan="5" class="text-center">Invoice</th> <th rowspan="2" class="hidden-print">View</th>
                                 </tr>
                                 <tr>
                                    <th class="text-center"># Boxes</th>
                                    <th class="text-center">Net Weight</br>(Kgs)</th>
                                    <th class="text-center">Total Mtrs</br>(Mtrs)</th>
                                    <th class="text-center"># Boxes</th>
                                    <th class="text-center">Net Weight</br>(Kgs)</th>
                                    <th class="text-center">Total Mtrs</br>(Mtrs)</th>
                                    <th class="text-center"># Boxes</th>
                              ...
                              <?php
                                 ...
                                 foreach ($item_detail['details'] as  $key=>$term_value) {
                                    ...
                                    <tr>
                                       ...
                                       <td><?=round($term_value[$status]['nt_wt'],2);?></td>
                                       <td><?=$term_value[$status]['mtrs'];?></td>
                                       <?php
                                       $status='dc';
                                       ?>
                                       <td><?=count($term_value[$status]['box_id']);?></td>
                                       ...
                                       <td class="hidden-print"><a href="<?=base_url(); ?>Mir_reports/tot_otw_item_wise_2/<?=$term_value['term']; ?>/<?=$key; ?>/<?=$month;?>" class="btn btn-info">View</a></td>
                                    </tr>
                                    <?php
                                    $sno++;
                                 }  
