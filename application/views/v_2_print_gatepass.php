                        ...
                        <table style="border:none;" class="table table-bordered table-striped table-condensed">
                           <thead>
                              <tr style="border:none;">
                                 ...
                                 <th width="20%" style="border-width:0px;"></th>
                                 <th width="20%" style="border-width:0px;"></th>
                                 <th width="40%" style="border-width:0px;"></th>
                              </tr>
                              <tr>
                           ...
                           <tbody>
                              <tr>
                                 <td>Gate Pass No</td>
                                 <td><strong style="font-size: 15px;"><?= $invoice_no; ?> / <?= date("d-m-Y"); ?> / <?= date("H:i:s"); ?></strong></td>
                                 <td>Invoice No</td>
                                 <td><strong style="font-size: 15px;"><?= $invoice_no; ?></strong></td>
                              </tr>
                              <tr>
                                 <td>Customer Code</td>
                                 <td><?= $customer; ?></td>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <?php foreach ($invoice_items as $val) {
                                       $a = $this->m_masters->find_hsn($val);
                                       echo substr($a[0]['hsn_code'], 0, 4);
                                    }
                                    ?>
                                 </td>
                                 <td></td>
                              ...
                              <tr>
                                 <td>Boxes Allowed</td>
                                 <td colspan="3"><strong style="font-size:20px;"><?= implode(", ", $boxes_array); ?></strong></td>
                              </tr>
                              <tr>
                                 <td colspan="4">
                                    <div class="col-lg-12">
