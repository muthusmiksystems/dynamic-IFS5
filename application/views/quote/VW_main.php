...
<div class="content-wrapper">
    ...
    <div class="container-fluid" style="padding-top: 10px;">
        ...
        <form action="<?= base_url('quote/sale_outward'); ?>" method="post" id="stock_inward">
            <table class=" table table-bordered  table-responsive">
                <thead>
                    <tr style="background:orange;font-weight:bolder;color:white">

                        <td align="center" colspan="6">Quotation </td>
                    ...
                    <tr>
                        ...
                        <td colspan="2" width="30%">
                            <select name="branch" style="border:solid thin black" id="branch" class="form-control" tabindex="1">
                                ...
                                <?php
                                $data = $this->user->get_table_data('tbl_company', 1, null, null, null);
                                foreach ($data as $row) {
                                ?>
            ...
            <div style="height: 290px;overflow: auto;width: 100%">
                <table id="myTable" class=" table table-responsive table-bordered order-list" style="width: 100%">
                ...
                <tbody style="background:#f2f2f2;">
                    <tr>
                        ...
                        <td width="70%" align="right">
                            <br>
                            Total Qty : <input type="number" name="total_qty" min="0" style="color:red;font-weight:bolder;" readonly id="total_qty" step="any" tabindex="-1">
                        </td>
                        <td width="30%" style="padding-left:5%" cellpadding="0" cellspacing="0">
                            <h1 style="font-size:35px;color:red" id="total_amount"> 0. 00 </h1>
                        </td>

                    </tr>
                    <tr>
                        <td align="left">
                            <i class="fa fa-inr"></i> &nbsp; <span style="text-transform: uppercase;font-weight:bolder;font-size:20px;color:blue" id="textAmount">zero rupees only /-</span>
                        </td>
                        <td width="30%" align="right">
                            <button type="submit" id="btn_hide" class="btn btn-success btn-sm"> <i class="fa fa-plus"></i> Save</button>
                        </td>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group form-float col-md-12">
                            <div class="form-line">
                                ...
                                <input type="text" class="form-control" name="name" style="border:solid thin black;height:38px" placeholder="Contact Person">
                            </div>
                        </div>
                        <div class="form-group form-float col-md-12">
                            <div class="form-line">

                                <input type="text" class="form-control" style="border:solid thin black;height:38px" maxlength="10" class="form-control" maxlength="10" name="phn_no" id="phone" placeholder="Phone No">
                            </div>
                        </div>
...
<script src="<?= base_url('assets'); ?>/vendor/search/jquery-ui.js"></script>
<script>
    $(document).ready(function() {
        ...
        */
        ...
        $.ajax({
            type: 'POST',
            url: '<?php echo base_url('quote/load_item_json'); ?>',
            success: function(response) {
        ...
        $(".addrow").on("click", function() {
            ...
            while (i < 10) {
                ...
                cols += '<td><strong></strong></td><td><input type="hidden" name="id[]" value="" id="id' + counter + '"><input type="text" class="form-control box" onblur="load_detail(this)" id="box' + counter + '" data-value="' + counter + '" name="name[]"/></td>';
