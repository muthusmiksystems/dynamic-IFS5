...
body{
 ...
 <style>
    ...
    .table {
        ...
        <style>
        #country-list{float:left;list-style:none;margin-top:-3px;padding:0;width:300px;position: absolute;}
	#country-list li{padding: 10px; background: #fff; border-bottom: #bbb9b9 1px solid;position: relative;z-index: 1;}
                ...
                <tbody style="background:white;">
                    <tr>
                            ...
                            <option value="">Choose Branch</option>
                              <?php
                                  ...
                                  ?>                              </select>
                                       ...
                                       <td colspan="1">                                               <input type="text" style="color:red;font-size:14px;font-weight:bolder;height: 38px" readonly="" id="bill_no" name="bill_no"  tabindex="-1"  value="" placeholder="Bill No" class="form-control" ="" />
                        </td>
                        <td >
                        ...
                        <td>
                           ...
                           <a href="<?=base_url('masters/items_4');?>" target="_blank" class="btn btn-success btn-md" ><i class="fa fa fa-plus-circle"></i> New Item </button>
                        </td>
                                    </tr>
                </tbody>
            </table>
            <div style="height: 340px;overflow: auto;margin-bottom: 10px">
                ...
                <tbody style="background:white;">
                  ...
                  { 
                      ...
                      while($i <= 100 )
                      {
                        ...
                        <td >
                            <input type="text" name="name[]"  class="form-control" id="textbox<?=$i;?>" autocomplete="off" name="job" onfocus="load_product(this)" onkeyup="load_product(this)" data-value="2" data-row="<?=$i;?>" data-table="bud_quote_items" data-load="1"  data-search="item_name" data-column="item_id as id,item_name as name,item_sample" placeholder="Type Item Name" > 
                        <div  class="suggesstion-box" id="suggesstion-box2"></div>
                        ...
                        <td>
                            <input type="number"  name="tax[]" step="0.01" value="0"  tabindex="" data-value="<?=$i;?>" id="tax<?=$i;?>" class="form-control"/>
                        </td>
                        <td>
                        ...
                        <td >
                            <input type="number"  min="0" step="0" name="qty[]" onkeyup="load_amount(this)" value="0" data-value="<?=$i;?>"  id="qty<?=$i;?>" class="form-control"/>
                                        ...
                                        <td >
                            <input type="number"  readonly min="0" tabindex="" step="0.01" name="amount[]" data-value="<?=$i;?>"  id="amount<?=$i;?>" value="0" class="form-control"/>
                        </td>
                        <td >
...
function load_product(Obj)
    {
        ...
        $.ajax({
              ...
              beforeSend: function(){
                $("#textbox"+value).css("background","#FFF url(<?=base_url('theme/images/LoaderIcon.gif');?>) no-repeat 165px");
              },                success: function(data){
                $("#suggesstion-box"+value).show();
                $("#suggesstion-box"+value).html(data);
                $("#textbox"+value).css("background","#FFF");
              }
          });
    }
</script>
