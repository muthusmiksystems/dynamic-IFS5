                    ...
                    <tbody style="background:#f2f2f2;">
                        <tr>
                            ...
                            <td width="30%" align="right">
                                <br>
                                Total Qty : <input type="number" name="total_qty" min="0" style="color:red;font-weight:bolder;width:180px" readonly id="total_qty" step="any" tabindex="-1"> <br>
                            </td>
