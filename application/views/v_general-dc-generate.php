                ...
                <div class="row">
                    <div class="col-lg-12">                                            <!-- Loading -->
                            <div class="pageloader"></div>
                              <!-- End Loading -->
                            <form class="cmxform form-horizontal tasi-form" role="form" id="commentForm" method="post" action="<?=base_url();?>general/generalDcSave">
                            <!-- Start Item List -->
                            <section class="panel">
                                <header class="panel-heading">
                                    DC No : 
                                ...
                                <div class="panel-body">
                                  ...
                                  <div class="form-group col-lg-3">
                                     <label for="dc_type">Type</label>
                                     <div style="clear:both;"></div>
                                     <label class="radio-inline">
                                       <input type="radio" name="dc_type" value="1" checked="checked"> Returnable
                                     </label>
                                     <label class="radio-inline">
                                       <input type="radio" name="dc_type" value="0"> Non Returnable
                                     </label>
                                  </div>
                                  <div class="form-group col-lg-3">
