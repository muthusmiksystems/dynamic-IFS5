                        ...
                        <section class="panel">
                            ...
                            <table class="table table-striped border-top display select" id="sample_1x">
                                ...
                                foreach ($table as $row) {
                                    ...
                                    $lotsarr = $this->ak->get_cust_gpo_prod_dyelot($row['gpono'], 2);
                                    $alotsarr = array();
                                    foreach ($lotsarr as $key => $value) {
                                        ...
                                        $value[0] = $regFlag . '<a class="btn btn-xs btn-' . (($value['dyl_status'] == 1) ? 'danger' : (($value['dyl_status'] == 2) ? 'warning' : (($value['dyl_status'] == 3) ? 'success' : ''))) . '"><b>P</b></a>';
                                        ...
                                        $value['dyl_action'] = '<a href="#lotapprove" lotno="' . $value['dyl_id'] . '" data-toggle="modal" class="btn btn-xs btn-primary lotapproveclick" title="Lot Approve"><i class="icon-comment"></i></a>';
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" method="post" action="<?= base_url(); ?>customer_purchase_order/po_gpo_shade_edit2/">
    ...
    <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="lotapprove" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form role="form" method="post" action="<?= base_url(); ?>customer_purchase_order/po_gpo_lot_cust_approve/">
                        <div class="form-group col-lg-12" style="margin-bottom: 15px;">
                            <div class="form-group">
                                <?php
                                $dost_lot_final_approval = $this->ak->dost_lot_final_approval();
                                foreach ($dost_lot_final_approval as $key => $option) {
                                    echo '<label for="dost_lot_final_approval' . $option['id'] . '" class="radio-inline"><input type="radio" name="dost_lot_final_approval" id="dost_lot_final_approval' . $option['id'] . '" class="dost_lot_final_approval" value="' . $option['id'] . '" required>' . $option['option'] . '</label>';
                                }
                                ?>
                            </div>
                            <div class="form-group">
        ...
        $(document).ready(function() {
            ...
            function CreateTableFromJSON(childJson) {
                ...
                if (childJson.length > 0) {
                    ...
                    tr.innerHTML = '<th>Flag</th><th>Prod. Lot No.</th><th>Fill Lot Qty</th><th>Mannual Lot No</th><th>Machine Name</th><th>Remarks</th><th>Lot Re-Correction</th><th>Accepted By</th><th>Action</th>';
            ...
            jQuery(".shadeupdateclick").on('click', function(e) {
                ...
                action = "<?= base_url(); ?>customer_purchase_order/po_gpo_shade_edit2/";
            ...
            jQuery(".lotapproveclick").on('click', function(e) {
                ...
                action = "<?= base_url(); ?>customer_purchase_order/po_gpo_lot_cust_approve/";
            ...
            jQuery(".lotapprovebtn").on('click', function(e) {
                return confirm('Dear User,\n\nNOTE: After you click save button, This Lot will be shifted to next form "Lot Report" after approved!.\n');
                e.preventDefault();
            });
