          ...
          <section class="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="row">
                    <div class="col-lg-12">
                      <form class="cmxform form-horizontal tasi-form" role="form" id="commentForm" method="post" action="<?=base_url()?>production/savedelivery">
                        <section class="panel">                                                <header class="panel-heading">
                                Packing Details
                            </header>                                                <div class="panel-body">
                              <div class="form-group col-lg-3">
                                <label for="delivery_date">Date</label>
                                <input class="form-control dateplugin" id="delivery_date" name="delivery_date" value="<?=date('d-m-Y'); ?>" type="text" required>
                              </div>
                              <div class="form-group col-lg-3">
  ...
  <script>
      ...
      $(function(){
        $("#customer_id").change(function () {
            ...
            var url = "<?=base_url()?>production/getdeliveryItems/"+customer_id;
