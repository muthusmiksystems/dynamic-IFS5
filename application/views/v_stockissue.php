                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                <h3><i class="icon-book"></i> Stock Issue</h3>
                            </header>
                        </section>
                    </div>
                </div>
                    ...
                    <div class="col-lg-12">
                      <form class="cmxform form-horizontal tasi-form" role="form" id="commentForm" method="post" action="<?=base_url(); ?>store/savestockissue">
                        <section class="panel">                                                <header class="panel-heading">
                              ...
                              <div class="form-group col-lg-4">
                                <label for="po_order">Job card No</label>
                              ...
                              <div class="form-group col-lg-4">
                                ...
                                <input class="form-control" id="po_qty" name="po_qty" type="text" readonly="readonly">
                              </div>
                              <div class="form-group col-lg-4">
                                <label for="po_issued_qty">Issued Quantity</label>
                                <input class="form-control" id="po_issued_qty" name="po_issued_qty" type="text">
                              </div>
                              <div class="form-group col-lg-4">
