                        ...
                        <table class="table table-striped border-top" id="sample_1">
                          ...
                          foreach ($quotations as $quotation) {
                            ...
                            <tr>
                                ...
                                <td>
                                  <?=$this->m_masters->getmasterIDvalue('bud_categories', 'category_id', $quotation['quote_category'], 'category_name'); ?>
                                </td>
                                <td class="">
                                  <?=$this->m_masters->getmasterIDvalue('bud_customers', 'cust_category', $quotation['quote_customer'], 'cust_name'); ?>
                                </td>
                                <td class="">
                                  <?=$quotation['quote_remarks']; ?>
                                </td>
                                <td>
                                  <a href="<?=base_url(); ?>productions/newjobinward/<?=$quotation['quote_id']; ?>" data-placement="top" data-original-title="View" data-toggle="tooltip" class="btn btn-success btn-xs tooltips"><i class="icon-file-text"></i></a>
