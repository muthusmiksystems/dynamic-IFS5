  ...
  <aside>
    <div id="sidebar"  class="nav-collapse ">
        ...
        <ul class="sidebar-menu">
            ...
            $is_manu_active = $this->m_users->is_manu_active('quote', 'upriv_controller', $this->session->userdata('user_viewed'));
            if(($is_manu_active && $is_admin) || $is_privileged)
            {
              ...
              <li class="sub-menu <?=(isset($activeTab) && $activeTab=='quote')?'active':'';?>">
                  ...
                  <ul class="sub">
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('index', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_manu_active && $is_admin) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('quoteReport', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_manu_active && $is_admin) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('successReport', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_manu_active && $is_admin) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('cancelReport', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_manu_active && $is_admin) || $is_privileged)
                    {
                      ?>
            ...
            <li class="sub-menu <?=(isset($activeTab) && $activeTab=='admin')?'active':'';?>">
                ...
                $is_manu_active = $this->m_users->is_manu_active('deletedBoxes', 'upriv_function', $this->session->userdata('user_viewed'));                
                ...
                $is_manu_active = $this->m_users->is_manu_active('deletedBoxes_1', 'upriv_function', $this->session->userdata('user_viewed'));                
                if($is_admin && $is_manu_active)
                {
                  ?>
				...
				$is_manu_active = $this->m_users->is_manu_active('deletedBoxes_3', 'upriv_function', $this->session->userdata('user_viewed'));                
                if($is_admin && $is_manu_active)
                {
                  ?>
            ...
            if(($is_manu_active && $is_admin) || $is_privileged)
            {
              ...
              <li class="sub-menu <?=(isset($activeTab) && $activeTab=='masters')?'active':'';?>">
                  ...
                  <ul class="sub">
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('operators', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
            ...
            if(($is_admin && $is_manu_active) || $is_privileged)
            {
              ...
              <li class="sub-menu <?=(isset($activeTab) && $activeTab=='purchase')?'active':'';?>">
                  ...
                  <ul class="sub">
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('po_list_lbl', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('prod_sheet_3', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
            ...
            if(($is_admin && $is_manu_active) || $is_privileged)
            {
              ...
              <li class="sub-menu <?=(isset($activeTab) && $activeTab=='production')?'active':'';?>">
                  ...
                  <ul class="sub">
                    ...
                    {
                      ?>
                      <li class="<?=($activeItem=='POrecieved')?'active':'';?>"><a class="" href="<?=base_url()?>production/POrecieved">Job Cards Receive</a></li>                
                      <?php
                    }
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('prod_entry_operator_reg_3', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
            ...
            if(($is_admin && $is_manu_active) || $is_privileged)
            {
              ...
              <li class="sub-menu <?=(isset($activeTab) && $activeTab=='packing')?'active':'';?>">
                  ...
                  <ul class="sub">
                    ...
                    {
                      ?>
                      <li class="<?=($activeItem=='zip_outerbox')?'active':'';?>"><a class="" href="<?=base_url()?>production/zip_outerbox">Zip Outerbox</a></li>                
                      <?php
                    }*/
                    ...
                    {
                      ?>
                      <li class="<?=($activeItem=='direct_packing')?'active':'';?>"><a class="" href="<?=base_url('directpack/packing_entry')?>">Direct Packing Entry</a></li>                
                      <?php
                    }
                    ?>
                  </ul>
            ...
            if(($is_admin && $is_manu_active) || $is_privileged)
            {
              ...
              <li class="sub-menu <?=(isset($activeTab) && $activeTab=='reports')?'active':'';?>">
                  ...
                  <ul class="sub">
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('roll_entry_report_3', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('stock_register_storeroom_wise_1', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                      <li class="<?=($activeItem=='stock_register_storeroom_wise_1')?'active':'';?>"><a class="" href="<?=base_url()?>reports/stock_register_storeroom_wise_1">Stock Register(SR Wise)</a></li>
                    <?php
                    }
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('po_report_lbl', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('boxStatus_3', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('poy_register_1', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
            ...
            if(($is_admin && $is_manu_active) || $is_privileged)
            {
              ...
              <li class="sub-menu <?=(isset($activeTab) && $activeTab=='mir_reports')?'active':'';?>">
                  ...
                  <ul class="sub">
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('item_pack_report_2', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('cust_sales_report_1', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('item_sales_report_1', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('item_pack_report_1', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('cust_sales_report_3', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('item_sales_report_3', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('item_pack_report_3', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('dyeing_sent_items_1', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                      <li class="<?=($activeItem=='dyeing_sent_items_1')?'active':'';?>"><a class="" href="<?=base_url()?>Mir_reports/dyeing_sent_items_1">Items Sent for Dyeing</a></li>                  
                      <?php
                    }
                    //Dyeing Reports
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('dyeinglots_against_po_1', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('dyeing_prod_rep_1', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('bal_in_dyeing_1', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('abstract_report_3', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('abstract_report_2', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('tot_inw_report_4', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('tot_otw_report_4', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('irr_report', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('irr_report_2', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('irr_report_3', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('tot_otw_report_2', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('tot_otw_report_3', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('poyvspacking_report_1', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
            ...
            if(($is_admin && $is_manu_active) || $is_privileged)
            {
              ...
              <li class="sub-menu <?=(isset($activeTab) && $activeTab=='store')?'active':'';?>">
                  ...
                  <ul class="sub">
                    ...
                    {
                      ?>
                      <li class="<?=($activeItem=='poy_sales')?'active':'';?>"><a class="" href="<?=base_url()?>store/poy_sales">POY Sales</a></li>                
                      <?php
                    }
                    ...
                    {
                      ?>
                      <li class="<?=($activeItem=='polyster_yarn')?'active':'';?>"><a class="" href="#">POLYSTER Yarn</a></li>                
                      <?php
                    }*/
                    ...
                    {
                      ?>
                      <li class="<?=($activeItem=='gray_yarn_soft')?'active':'';?>"><a class="" href="<?=base_url()?>store/gray_yarn_soft">Gray Yarn Soft Packing</a></li>                
                      <?php
                    }
                    ...
                    {
                      ?>
                      <li class="<?=($activeItem=='dyed_thread_inner')?'active':'';?>"><a class="" href="<?=base_url()?>store/dyed_thread_inner">Dyed Thread inner</a></li>                
                      <?php
                    }
                    ...
                    {
                      ?>
                      <li class="<?=($activeItem=='dyed_thread_outer')?'active':'';?>"><a class="" href="<?=base_url()?>store/dyed_thread_outer">Dyed Thread outer</a></li>                
                      <?php
                    }
                    ...
                    {
                      ?>
                      <li class="<?=($activeItem=='dyed_thread_packing')?'active':'';?>"><a class="" href="<?=base_url()?>store/dyed_thread_packing">Dyed Thread Packing</a></li>                
                      <?php
                    }
            ...
            if(($is_admin && $is_manu_active) || $is_privileged)
            {
              ...
              <li class="sub-menu <?=(isset($activeTab) && $activeTab=='shop')?'active':'';?>">
                  ...
                  <ul class="sub">
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('returned_dc', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('rdc_report_sh', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
                      <li class="<?=($activeItem=='rdc_report_sh')?'active':'';?>"><a class="" href="<?=base_url()?>shop/delivery/rdc_report_sh">Returned DC Register</a></li>                  
                      <?php
                    }
                    //ER-08-18#-37
                    ...
                    {
                      ?>
                      <li class="<?=($activeItem=='cust_item_est_reg')?'active':'';?>"><a class="" href="<?=base_url()?>estimate/cust_item_est_reg">Cust.Item Target Reg</a></li>                  
                      <?php
                    }
            ...
            if(($is_admin && $is_manu_active) || $is_privileged)
            {
              ...
              <li class="sub-menu <?=(isset($activeTab) && $activeTab=='shop_registers')?'active':'';?>">
                  ...
                  <?php
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('box_status', 'upriv_function', $this->session->userdata('user_viewed'));
                    ?>
                  ...
                  <?php
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('pdc_report_sh', 'upriv_function', $this->session->userdata('user_viewed'));
                    ?>
                    <?php if(($is_admin) || $is_privileged): ?>
                  ...
                  <?php
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('dc_report_sh', 'upriv_function', $this->session->userdata('user_viewed'));
                    ?>
                    <?php if(($is_admin) || $is_privileged): ?>
                  ...
                  <?php
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('inv_report_sh', 'upriv_function', $this->session->userdata('user_viewed'));
                    ?>
                    <?php if(($is_admin) || $is_privileged): ?>
                  ...
                  <?php
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('inward_report_sh', 'upriv_function', $this->session->userdata('user_viewed'));
                    ?>
                    <?php if(($is_admin) || $is_privileged): ?>
                  ...
                  <?php
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('enquiry_report_sh', 'upriv_function', $this->session->userdata('user_viewed'));
                    ?>
                    <?php if(($is_admin) || $is_privileged): ?>
                  ...
                  <?php
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('deleted_report_sh', 'upriv_function', $this->session->userdata('user_viewed'));
                    ?>
                    <?php if(($is_admin) || $is_privileged): ?>
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('irr_report_sh', 'upriv_function', $this->session->userdata('user_viewed'));
                    ?>
                    <?php if(($is_admin) || $is_privileged): ?>
            ...
            if(($is_admin && $is_manu_active) || $is_privileged)
            {
              ...
              <li class="sub-menu <?=(isset($activeTab) && $activeTab=='registers')?'active':'';?>">
                  ...
                  <ul class="sub">
                    ...
                    $is_manu_active = $this->m_users->is_manu_active('box_status_yt', 'upriv_function', $this->session->userdata('user_viewed'));
                    if(($is_admin && $is_manu_active) || $is_privileged)
                    {
                      ?>
