      ...
      <section id="container" class="">
         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               $item_name = null;                      ?>
               <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>reports/deletedBoxes_3">
                  <div class="row">
                     <div class="col-lg-12">
                        <section class="panel">
               ...
               echo "</pre>";*/
               ?>
               <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>reports/deletePermBoxes_3">
               <div class="row">
               <div class="col-lg-12">
                  <!-- Start Talbe List  -->                                  <section class="panel">
                    ...
                    <div class="panel-body">                                                           <table id="example" class="table table-bordered table-striped table-condensed cf packing-register">
                         <thead>
                           <tr>
                              <th>#</th>                                               <th>Box No</th>
                              <th>Item Name</th>
                           ...
                           foreach ($outerboxes as $row) {
                              ...
                              <tr>
                                 ...
                                 <td><?=$row['deleted_time']; ?></td>
                                 <td>
                                    <input type="checkbox" class="checkbox" name="selected_boxes[]" value="<?=$box_no; ?>">
                                 </td>
                              </tr>
                              <?php
                              $sno++;
