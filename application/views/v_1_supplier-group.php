          ...
          <div class="col-lg-12">
            <section class="panel">
              <header class="panel-heading">
                <h3><i class="icon-group"></i> Supplier Group</h3>
              </header>
            </section>
          </div>
        </div>
          ...
          <div class="col-lg-12">
            <section class="panel">
              <div class="panel-body">
                ...
                <?php
                if (isset($group_id)) {
                  $result = $this->m_masters->getmasterdetails('bud_yt_supplier_groups', 'group_id', $group_id);
                ...
                ?> <form class="cmxform form-horizontal tasi-form" role="form" id="commentForm" method="post" action="<?= base_url(); ?>masters/savesupplierGroup">
                ...
                <tbody>
                  ...
                  ?>
                    <tr class="odd gradeX">
                      ...
                      <td>
                        <a href="<?= base_url(); ?>masters/supplierGroup/<?= $row['group_id']; ?>" data-placement="top" data-original-title="Edit" data-toggle="tooltip" class="btn btn-primary btn-xs tooltips"><i class="icon-pencil"></i></a>
                      </td>
                    </tr>
                  <?php
                    $sno++;
