          ...
          <section class="wrapper">
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                <h3><i class="icon-user"></i> Denier Master</h3>
                            </header>
                        </section>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                      ...
                      if(isset($denier_id))
                      {
                        $editdeniers = $this->m_masters->getmasterdetails('bud_deniermaster','denier_id', $denier_id);
                      ...
                      ?> 
                      <form class="cmxform form-horizontal tasi-form" role="form" id="commentForm" method="post" action="<?=base_url();?>masters/deniermaster_save">
                        <section class="panel">
                            <header class="panel-heading">
                                Details
                            </header>
                                ...
                                ?>
                                <input type="hidden" name="denier_id" value="<?=$denier_id; ?>">                                                                                                <div class="form-group col-lg-12">
                                    <label class="control-label col-lg-2">POY Denier</label>
                                    <div class="col-lg-10">
                                      Master
                                    </div>
                                </div>
                          ...
                          <tbody>
                            ...
                            foreach ($deniers as $denier) {
                              ...
                              <tr class="odd gradeX">
                                  ...
                                  <td>
                                    <a href="<?=base_url();?>masters/deniermaster/<?=$denier['denier_id']; ?>" data-placement="top" data-original-title="Edit" data-toggle="tooltip" class="btn btn-primary btn-xs tooltips"><i class="icon-pencil"></i></a>
