      ...
      <section id="container" class="">
         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               $item_name = null;               
               ?>
               <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>reports/deletedBoxes_1">
                  <div class="row">
                     <div class="col-lg-12">
                        <section class="panel">
               ...
               echo "</pre>";*/
               ?>
               <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>reports/deletePermBoxes_1">
               <div class="row">
               <div class="col-lg-12">
                  <!-- Start Talbe List  -->                        
                  <section class="panel">
                       ...
                       <table id="example" class="table table-bordered table-striped table-condensed cf packing-register">
                         <thead>
                           ...
                           foreach ($outerboxes as $row) {
                              ...
                              <script>
                                 data.push( [ '<?=$sno; ?>', '<?=$row['box_prefix']; ?><?=$box_no; ?>', '<?=$row['item_name']; ?>', '<?=$row['item_id']; ?>', '<?=($row['lot_no'] == 0)?'':$row['lot_no']; ?>', '<?=$row['shade_name']; ?>', '<?=$row['shade_id']; ?>', '<?=number_format((float)$row['gross_weight'], 3, '.', ''); ?>', '<?=number_format((float)$row['net_weight'], 3, '.', '') ?>', '<?=$row['remarks']; ?>', '<input type="checkbox" class="checkbox" name="selected_boxes[]" value="<?=$box_id; ?>">' ] );
                              </script>
                        ...
                        <button class="btn btn-danger" type="submit" name="delete">Final Delete</button>
