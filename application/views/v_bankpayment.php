  ...
  <section id="container" class="">
      ...
      <section id="main-content">
          <section class="wrapper">
                    ...
                    <div class="col-lg-12">
                        <section class="panel">
                            <header class="panel-heading">
                                <h3><i class="icon-book"></i> Bank Payment</h3>
                            </header>
                        </section>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                      <form class="cmxform form-horizontal tasi-form" role="form" id="commentForm" method="post" action="<?=base_url(); ?>accounts/savebankpayment">                                        <section class="panel">                                                <header class="panel-heading">
                                Details
                            </header>
                            <div class="panel-body">
                              ...
                              <div class="form-group col-lg-4">
                                ...
                                <label for="payment_type">A/c Type</label>
                              ...
                              <div class="form-group col-lg-4">
                                <label for="payment_mode">Type</label>
                                <input class="form-control" id="payment_mode" name="payment_mode" type="text" required>
                              </div>
                              <div class="form-group col-lg-4">
                                <label for="payment_mode_no">Che/DD No</label>
