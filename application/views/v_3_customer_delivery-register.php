         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               $items = $this->m_masters->getactivemaster('bud_lbl_items', 'item_status');
                      ?>
               <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>reports/custdeliveryRegister_3">
                  <div class="row">
                     <div class="col-lg-12">
               ...
               foreach ($cust_pack_register as $customer_id => $outerboxes) {
                  foreach ($outerboxes as $key => $row) {
                     ...
                     $qty = $this->m_production->boxDeliveredQty($box_no,null,null,null,$row->delivery_id,null);//partial delivery qty
                     $gr_total_qty += $qty;
               ...
               <div class="col-lg-12">
                  <!-- Start Talbe List  -->                                  <section class="panel">
                    <header class="panel-heading">
                        ...
                        <h3 class="visible-print">Customer &amp; Item Delivery Register (Labels)</h3>
                        <div class="col-sm-6">
