      ...
      <section id="container" class="">
         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>reports/deletedboxRegister">
                  <div class="row">
                     <div class="col-lg-12">
               ...
               <div class="col-lg-12">
                  <!-- Start Talbe List  -->                                  <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        ?>
                        <h3 class="visible-print">Deleted Boxes Register (Tapes &amp; Elastic)</h3>
                        <div class="col-sm-6">
                         ...
                         <thead>
                           ...
                           foreach ($outerboxes as $row) {
                              ...
                              <tr>
                                 ...
                                 <td><?=date("d-m-Y", strtotime($row['packing_date'])); ?> <?=$row['packing_time']?></td>
