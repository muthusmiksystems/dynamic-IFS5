      ...
      <section id="container" class="">
         ...
         <section id="main-content">
            <section class="wrapper">
               ...
               <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>reports/custinvoiceRegister">
                  <div class="row">
                     <div class="col-lg-12">
                        <section class="panel">                                               <header class="panel-heading">
                              Invoice Register Customer Wise
                           </header>
               ...
               foreach ($cust_pack_register as $customer_id => $outerboxes) {
                  foreach ($outerboxes as $row) {
                     ...
                     $gr_total_meters += round($row->total_meters);
                     $gr_total_boxes++;
                  }
               }
               ?>
               ...
               <div class="col-lg-12">
                  <!-- Start Talbe List  -->                                  <section class="panel">
                    <header class="panel-heading">
                        Summary
                    </header>                         <div class="panel-body">                                        <h3 class="visible-print">Customer &amp; Item Invoice Register (Tapes &amp; Elastic)</h3>
                        <div class="col-sm-6">
                        ...
                        foreach ($cust_pack_register as $customer_id => $outerboxes) {
                           ...
                           <table class="datatable table table-bordered table-striped table-condensed cf packing-register">
                            <thead>
                              <?php
                              if(++$i == 1)
                              {
                                 ...
                                 <tr>
                                    ...
                                    <td><strong><?php echo $gr_total_meters; ?></strong></td>
                                    <td></td><!--//ER-08-18#-33-->
                                    <td></td>
                                 </tr>
                                 <?php
                              ...
                              foreach ($outerboxes as $row) {
                                 ...
                                 $packing_net_weight = doubleval($row->packing_net_weight);
                                 ...
                                 //ER-08-18#-33
                                 $condition=array('invoice_id'=>$row->invoice_id,'item_id'=>$row->item_id,'is_deleted'=>1);
                                 $rate=$this->m_mir->get_two_table_values('bud_te_predelivery_items','','item_rate','','',$condition)[0]['item_rate'];
                                 //ER-08-18#-33
                                 ?>
                                 <tr>
                                    <td><?=$sno; ?></td>
                                    ...
                                    <td><?=number_format($packing_net_weight,2); ?></td>
                                    <td><?=round($total_meters); ?></td>
                                    <td><?=$rate;?></td><!--//ER-08-18#-33-->
