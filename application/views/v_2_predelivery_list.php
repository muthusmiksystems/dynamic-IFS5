   ...
   <body>
                          ...
                          <div class="panel-body">
                              ...
                              <tbody>
                                ...
                                foreach ($pre_deliveries as $row) {
                                  $box_ids = explode(",", $row['p_delivery_boxes']);
                                  $boxes = $this->m_delivery->get_tap_predelivery_items($box_ids);
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                      <a href="<?=base_url(); ?>production/predelivery_2_edit/<?=$row['p_delivery_id']; ?>" class="btn btn-primary btn-xs">Edit</a>
                                      ...
                                      <!--end of deletion of predelivery tapes-->                                  <a href="<?=base_url(); ?>production/predelivery_2_print/<?=$row['p_delivery_id']; ?>" class="btn btn-success btn-xs">Print</a>
                                    </td>
                                  </tr>
                                  <?php
                                  $sno++;
    ...
    <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
      ...
      function deletedc(){
        ...
        var url = "<?php echo base_url('production/predelivery_2_delete')?>";
        $.ajax({
            type: "POST",
            url: url,
            data:  {
