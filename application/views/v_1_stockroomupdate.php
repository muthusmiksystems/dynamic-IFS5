   ...
   <section id="container" class="">
      ...
      <section id="main-content">
         <section class="wrapper sh_delivery">
               ...
               <div class="col-lg-12">
                  <section class="panel">
                     <header class="panel-heading">
                        <h3><i class=" icon-truck"></i> Stock Room Box Update</h3>
                     </header>
                  </section>
               </div>
            </div>
                              ...
                              foreach ($d_outerboxes as $row) {
                                 ...
                                 <script>
                                    data.push([
                                       ...
                                       '<?= $net_weight; ?>',
                                       '<?= $stock_room_name; ?>',
                                       '<?= $row['building_name'] . ', ' . $row['block_name'] . ', ' . $row['rack_name']; ?>',
                                       '<?= $statusall; ?>'
                                    ]);
                                 </script>
                              <?php
            ...
            <form class="cmxform form-horizontal tasi-form" role="form" id="commentForm" method="post" action="<?= base_url(); ?>masters/stockroomupdate_save">
               <div class="row">
                  <div class="col-lg-12">
                     <section class="panel">
                        <header class="panel-heading">
                        ...
                        <div class="panel-body">
                           ...
                           <div class="form-group col-lg-3">
                              ...
                              <div><span id="rack_count">0 - 0 = 0 - </span><span id="rack_count_box">0</span></div>
                           </div>
                  ...
                  <div class="col-lg-12">
                     <section class="panel">
                        <header class="panel-heading">
                           <button class="btn btn-danger saveroomtobox" type="submit" name="save">Update</button>
                        </header>
                     </section>
                  </div>
               </div>
