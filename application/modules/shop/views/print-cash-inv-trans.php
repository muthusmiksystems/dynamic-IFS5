            ...
            <div class="col-lg-12">
                <section class="panel">
                    <header class="panel-heading">
                        Print Shop Cash Invoice Cash Transfer
                    </header>
                    <div class="panel-body">
                        <?php if($transfer): ?>
                            <?php
                            $invoice_amt = 0;
                            $invoice_ids = explode(",", $transfer->invoice_ids);                            
                            ?>
                            <table class="table table-bordered invoice-table">
                                <thead>
                                    <tr>
                                        <th colspan="8" class="text-center">
                                            <strong><?php echo strtoupper('Cash Invoice Cash Transfer'); ?></strong>
                                        </th>
                                    </tr>
                                    <tr>
                                    ...
                                    if(count($invoice_ids) > 0):
                                        foreach ($invoice_ids as $invoice_id):
                                            ...
                                            if($invoice):
                                                ...
                                                $invoice_nos[] = 'SHOP-'.$invoice->invoice_no;
                                                $invoice_amt += $invoice->invoice_amt;
                                            ?>
                                            <tr>
                                                <td><?php echo $sno++; ?></td>
                                                <td>SHOP-<?php echo $invoice->invoice_no; ?></td>
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <td><strong><?php echo number_format($invoice_amt, 2, '.', ''); ?></strong></td>
                                    </tr>
                                    <tr>
                                        <td colspan="8">
