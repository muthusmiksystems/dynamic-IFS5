<section class="panel">
	<div class="panel-body">
		...
		<form role="form" action="<?php echo base_url('shop/stocktrans/accept_dc_save'); ?>" method="post" accept-charset="utf-8" id="acceptForm">
			<input type="hidden" name="id" id="id" value="<?php echo $id; ?>">
			<div class="form-group">
				<label for="name">Remarks</label>
				<textarea name="recieved_remarks" id="recieved_remarks" class="form-control">Recd qty OK</textarea>
			</div>
			<div class="form-group">
