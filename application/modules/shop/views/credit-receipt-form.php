            ...
            <div class="col-lg-12">
                <section class="panel">
                    ...
                    <div class="panel-body">
                        ...
                        <form class="cmxform" role="form" method="post" id="ajaxForm" action="<?php echo base_url('shop/sales/credit_receipt_save'); ?>">
                            <div class="row">
                                <div class="form-group col-lg-3">
                                    Receipt No <label class="label label-danger" style="font-size:14px;">SHOP CREDIT NOTE - <span id="receipt_no">1</span></label>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <tbody>
                                ...
                                <?php if(sizeof($receipt_list) > 0): ?>
                                    <?php foreach($receipt_list as $row): ?>
                                        <tr>
                                            <td><?php echo $sno++; ?></td>
                                            <td>SHOP CREDIT NOTE-<?php echo $row->receipt_id; ?></td>
                                            ...
                                            <th>
                                                <a href="<?php echo base_url('shop/sales/print_credit_receipt/'.$row->receipt_id); ?>" target="_blank" class="btn btn-xs btn-primary">Print</a>
                                            </th>
                                        </tr>
                                    <?php endforeach; ?>
                                <?php endif; ?>
...
<script type="text/javascript">
            ...
            success: function(data)
            {
                ...
                $.each(response, function(k, v) {
                    ...
                    if(k=='receipt_id')
                    {
                        ...
                        window.location.href = "<?php echo base_url('shop/sales/print_credit_receipt'); ?>/"+v;
                    }
                });
                get_credit_receipt_no();
            }
    ...
    function get_credit_receipt_no() {
        $.ajax({
            url: "<?php echo base_url('shop/sales/get_credit_receipt_no'); ?>",
