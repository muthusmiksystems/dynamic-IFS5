<?php include APPPATH.'views/html/header.php'; ?>
	...
	<section id="main-content">
		<section class="wrapper">
            <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>shop/registers/dc_report_sh">
              <div class="row">
                 <div class="col-lg-12">
                    <section class="panel">                            
                                ...
                                <tbody>
                                    ...
                                    <?php if(sizeof($delivery_list) > 0): ?>
                                        <?php foreach($delivery_list as $row): ?>
                                            ...
                                            $item_boxes = array();
                                            $check=1;//ER-08-18#-29
                                            $delivery_items = $this->Delivery_model->get_delivery_items($row->delivery_id,'');//ER-08-18#-29
