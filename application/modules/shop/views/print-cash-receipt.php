                            ...
                            <thead>
                                ...
                                <tr>
                                    ...
                                    <th colspan="2" class="text-right">
                                        <span class="voucher-name">Cash Receipt</span>
                                    </th>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td align="left" colspan="2">
                                        No: <span class="voucher-no">RECEIPT-<?php echo $receipt->receipt_id; ?></span>
                                    </td>
                                    <td align="right" colspan="2">
                                        Date: <?php echo date("d-m-Y g:i A", strtotime($receipt->receipt_date)); ?>
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right">
                                ...
                                <tr>
                                    <td class="no-border-right">
                                        <h5>Payment Received through.</h5>
                                        <br>
                                        <br>
                                        Mr: <?php echo $receipt->name; ?>
                                        Mobile: <?php echo $receipt->mobile_no; ?>
                                    </td>
                                    <td align="center" class="no-border-right no-border-left">
                                    ...
                                    <td align="right" colspan="2" class="no-border-left">
                                        <strong>For <?php echo $receipt->concern_name; ?></strong>
                                        <br>
                                        <br>
                                        <br>
                                        <br>
                                        (Cash Recd.By) Auth.Sign.
                                    </td>
                                </tr>
                            </tbody>
                        </table>
