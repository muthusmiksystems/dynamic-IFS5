                        ...
                        <table class="table voucher-table table-bordered invoice-table">
                            <thead>
                                <tr style="height: 0px;" class="no-padding no-border">
                                    <th style="padding: 0px;border-width: 0px;" width="35%"></th>
                                    <th style="padding: 0px;border-width: 0px;" width="20%"></th>
                                    <th style="padding: 0px;border-width: 0px;" width="17%"></th>
                                    <th style="padding: 0px;border-width: 0px;" width="28%"></th>
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                <tr>
                                    <td align="left" colspan="2">No: <span class="voucher-no">SHOP Debit.Note-<?php echo $receipt->receipt_id; ?></span></td>
                                    <!-- <td colspan="2"></td> -->
                                    <!-- <td align="right"></td> -->
