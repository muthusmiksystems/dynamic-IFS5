<?php include APPPATH.'views/html/header.php'; ?>
	...
	<section id="main-content">
		<section class="wrapper">
            <form class="cmxform form-horizontal tasi-form screen-only" role="form" id="commentForm" method="post" action="<?=base_url()?>shop/registers/enquiry_report_sh">
              <div class="row">
                 <div class="col-lg-12">
                    <section class="panel">                            
                                ...
                                <tbody>
                                    ...
                                    <?php if(sizeof($invoices_list) > 0): ?>
                                        <?php foreach($invoices_list as $row): ?>
                                            ...
                                            $dcs=array();
                                            $check=1;//ER-08-18#-29
                                            $invoices_items =$this->Sales_model->get_quotation_items($row->quotation_id,'');//ER-08-18#-29
